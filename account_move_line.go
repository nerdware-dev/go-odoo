...
type AccountMoveLine struct {
	...
	CanBePaid               *Selection `xmlrpc:"can_be_paid,omptempty"`
	...
	FollowupDate            *Time      `xmlrpc:"followup_date,omptempty"`
	...
	IntrastatTransactionId  *Many2One  `xmlrpc:"intrastat_transaction_id,omptempty"`
	IsAngloSaxonLine        *Bool      `xmlrpc:"is_anglo_saxon_line,omptempty"`
	...
	ReconciliationInvoiceId *Relation  `xmlrpc:"reconciliation_invoice_id,omptempty"`
	...
	SubscriptionEndDate     *Time      `xmlrpc:"subscription_end_date,omptempty"`
	SubscriptionId          *Many2One  `xmlrpc:"subscription_id,omptempty"`
	SubscriptionMrr         *Float     `xmlrpc:"subscription_mrr,omptempty"`
	SubscriptionStartDate   *Time      `xmlrpc:"subscription_start_date,omptempty"`

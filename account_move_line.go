...
type AccountMoveLine struct {
	AccountCode                    *String     `xmlrpc:"account_code,omitempty" json:"account_code,omitempty"`
	...
	AccountName                    *String     `xmlrpc:"account_name,omitempty" json:"account_name,omitempty"`
	...
	CommercialPartnerCountry       *Many2One   `xmlrpc:"commercial_partner_country,omitempty" json:"commercial_partner_country,omitempty"`
	...
	IsImported                     *Bool       `xmlrpc:"is_imported,omitempty" json:"is_imported,omitempty"`

...
type ProjectTask struct {
	...
	ClosedDependOnCount           *Int        `xmlrpc:"closed_depend_on_count,omitempty" json:"closed_depend_on_count,omitempty"`
	...
	CurrentUserSameCompanyPartner *Bool       `xmlrpc:"current_user_same_company_partner,omitempty" json:"current_user_same_company_partner,omitempty"`
	...
	DependOnCount                 *Int        `xmlrpc:"depend_on_count,omitempty" json:"depend_on_count,omitempty"`
	...
	DisplayFollowButton           *Bool       `xmlrpc:"display_follow_button,omitempty" json:"display_follow_button,omitempty"`
	...
	HtmlFieldHistory              interface{} `xmlrpc:"html_field_history,omitempty" json:"html_field_history,omitempty"`
	HtmlFieldHistoryMetadata      interface{} `xmlrpc:"html_field_history_metadata,omitempty" json:"html_field_history_metadata,omitempty"`
	Id                            *Int        `xmlrpc:"id,omitempty" json:"id,omitempty"`
	IsClosed                      *Bool       `xmlrpc:"is_closed,omitempty" json:"is_closed,omitempty"`
	LinkPreviewName               *String     `xmlrpc:"link_preview_name,omitempty" json:"link_preview_name,omitempty"`
	...
	SaleOrderState                *Selection  `xmlrpc:"sale_order_state,omitempty" json:"sale_order_state,omitempty"`
	Sequence                      *Int        `xmlrpc:"sequence,omitempty" json:"sequence,omitempty"`
	ShowDisplayInProject          *Bool       `xmlrpc:"show_display_in_project,omitempty" json:"show_display_in_project,omitempty"`
	...
	SubtaskCompletionPercentage   *Float      `xmlrpc:"subtask_completion_percentage,omitempty" json:"subtask_completion_percentage,omitempty"`
	...
	UserSkillIds                  *Relation   `xmlrpc:"user_skill_ids,omitempty" json:"user_skill_ids,omitempty"`

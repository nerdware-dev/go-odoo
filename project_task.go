...
type ProjectTask struct {
	...
	PlannedDateBeginFormatted   *String    `xmlrpc:"planned_date_begin_formatted,omitempty"`
	PlannedDateEnd              *Time      `xmlrpc:"planned_date_end,omitempty"`
	...
	TimesheetTimerFirstStart    *Time      `xmlrpc:"timesheet_timer_first_start,omitempty"`
	TimesheetTimerLastStop      *Time      `xmlrpc:"timesheet_timer_last_stop,omitempty"`
	TimesheetTimerPause         *Time      `xmlrpc:"timesheet_timer_pause,omitempty"`
	TimesheetTimerStart         *Time      `xmlrpc:"timesheet_timer_start,omitempty"`

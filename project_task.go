...
type ProjectTask struct {
	...
	PlannedDateBeginFormatted   *String    `xmlrpc:"planned_date_begin_formatted,omptempty"`
	...
	TimesheetTimerFirstStart    *Time      `xmlrpc:"timesheet_timer_first_start,omptempty"`
	TimesheetTimerLastStop      *Time      `xmlrpc:"timesheet_timer_last_stop,omptempty"`
	TimesheetTimerPause         *Time      `xmlrpc:"timesheet_timer_pause,omptempty"`
	TimesheetTimerStart         *Time      `xmlrpc:"timesheet_timer_start,omptempty"`

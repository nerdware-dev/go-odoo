...
type ProjectTask struct {
	...
	DependencyWarning               *String     `xmlrpc:"dependency_warning,omitempty"`
	...
	DisplayTimerStartSecondary      *Bool       `xmlrpc:"display_timer_start_secondary,omitempty"`
	DisplayTimerStop                *Bool       `xmlrpc:"display_timer_stop,omitempty"`
	DisplayTimesheetTimer           *Bool       `xmlrpc:"display_timesheet_timer,omitempty"`
	DisplayWarningDependencyInGantt *Bool       `xmlrpc:"display_warning_dependency_in_gantt,omitempty"`
	...
	DocumentsFolderId               *Many2One   `xmlrpc:"documents_folder_id,omitempty"`
	...
	LeaveWarning                    *String     `xmlrpc:"leave_warning,omitempty"`
	...
	PartnerStreet                   *String     `xmlrpc:"partner_street,omitempty"`
	...
	PlannedDateBegin                *Time       `xmlrpc:"planned_date_begin,omitempty"`
	PlannedDateStart                *Time       `xmlrpc:"planned_date_start,omitempty"`
	PlanningOverlap                 *String     `xmlrpc:"planning_overlap,omitempty"`
	PortalEffectiveHours            *Float      `xmlrpc:"portal_effective_hours,omitempty"`
	PortalProgress                  *Float      `xmlrpc:"portal_progress,omitempty"`
	PortalRemainingHours            *Float      `xmlrpc:"portal_remaining_hours,omitempty"`
	PortalSubtaskEffectiveHours     *Float      `xmlrpc:"portal_subtask_effective_hours,omitempty"`
	PortalTotalHoursSpent           *Float      `xmlrpc:"portal_total_hours_spent,omitempty"`
	...
	ProjectUseDocuments             *Bool       `xmlrpc:"project_use_documents,omitempty"`
	...
	SharedDocumentCount             *Int        `xmlrpc:"shared_document_count,omitempty"`
	SharedDocumentIds               *Relation   `xmlrpc:"shared_document_ids,omitempty"`
	...
	UserNames                       *String     `xmlrpc:"user_names,omitempty"`

...
func (c *Client) CreateDigestTips(dts []*DigestTip) ([]int64, error) {
	...
	return c.Create(DigestTipModel, vv)
}
...
func (c *Client) FindDigestTip(criteria *Criteria) (*DigestTip, error) {
	...
	return nil, fmt.Errorf("digest.tip was not found with criteria %v", criteria)
}
...
func (c *Client) FindDigestTipId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("digest.tip was not found with criteria %v and options %v", criteria, options)
}

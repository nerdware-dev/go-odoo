...
type ProjectShareCollaboratorWizard struct {
	...
	ParentWizardId *Many2One  `xmlrpc:"parent_wizard_id,omitempty" json:"parent_wizard_id,omitempty"`
	PartnerId      *Many2One  `xmlrpc:"partner_id,omitempty" json:"partner_id,omitempty"`
	SendInvitation *Bool      `xmlrpc:"send_invitation,omitempty" json:"send_invitation,omitempty"`

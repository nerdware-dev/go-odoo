...
type ResCompany struct {
	...
	AccountDisplayRepresentativeField           *Bool       `xmlrpc:"account_display_representative_field,omitempty" json:"account_display_representative_field,omitempty"`
	AccountEnabledTaxCountryIds                 *Relation   `xmlrpc:"account_enabled_tax_country_ids,omitempty" json:"account_enabled_tax_country_ids,omitempty"`
	...
	AccountRepresentativeId                     *Many2One   `xmlrpc:"account_representative_id,omitempty" json:"account_representative_id,omitempty"`
	AccountRevaluationExpenseProvisionAccountId *Many2One   `xmlrpc:"account_revaluation_expense_provision_account_id,omitempty" json:"account_revaluation_expense_provision_account_id,omitempty"`
	...
	AccountTaxUnitIds                           *Relation   `xmlrpc:"account_tax_unit_ids,omitempty" json:"account_tax_unit_ids,omitempty"`
	...
	AliasDomainName                             *String     `xmlrpc:"alias_domain_name,omitempty" json:"alias_domain_name,omitempty"`
	AllChildIds                                 *Relation   `xmlrpc:"all_child_ids,omitempty" json:"all_child_ids,omitempty"`
	...
	AttendanceKioskKey                          *String     `xmlrpc:"attendance_kiosk_key,omitempty" json:"attendance_kiosk_key,omitempty"`
	...
	BounceFormatted                             *String     `xmlrpc:"bounce_formatted,omitempty" json:"bounce_formatted,omitempty"`
	...
	CatchallFormatted                           *String     `xmlrpc:"catchall_formatted,omitempty" json:"catchall_formatted,omitempty"`
	...
	EmployeePropertiesDefinition                interface{} `xmlrpc:"employee_properties_definition,omitempty" json:"employee_properties_definition,omitempty"`
	...
	FiscalPositionIds                           *Relation   `xmlrpc:"fiscal_position_ids,omitempty" json:"fiscal_position_ids,omitempty"`
	...
	L10NDeStnr                                  *String     `xmlrpc:"l10n_de_stnr,omitempty" json:"l10n_de_stnr,omitempty"`
	L10NDeWidnr                                 *String     `xmlrpc:"l10n_de_widnr,omitempty" json:"l10n_de_widnr,omitempty"`
	...
	MaxTaxLockDate                              *Time       `xmlrpc:"max_tax_lock_date,omitempty" json:"max_tax_lock_date,omitempty"`
	...
	MultiVatForeignCountryIds                   *Relation   `xmlrpc:"multi_vat_foreign_country_ids,omitempty" json:"multi_vat_foreign_country_ids,omitempty"`
	...
	ParentIds                                   *Relation   `xmlrpc:"parent_ids,omitempty" json:"parent_ids,omitempty"`
	...
	SaleDiscountProductId                       *Many2One   `xmlrpc:"sale_discount_product_id,omitempty" json:"sale_discount_product_id,omitempty"`
	SaleDownPaymentProductId                    *Many2One   `xmlrpc:"sale_down_payment_product_id,omitempty" json:"sale_down_payment_product_id,omitempty"`
	...
	TimesheetMailAllow                          *Bool       `xmlrpc:"timesheet_mail_allow,omitempty" json:"timesheet_mail_allow,omitempty"`
	TimesheetMailDelay                          *Int        `xmlrpc:"timesheet_mail_delay,omitempty" json:"timesheet_mail_delay,omitempty"`
	...
	TimesheetMailInterval                       *Selection  `xmlrpc:"timesheet_mail_interval,omitempty" json:"timesheet_mail_interval,omitempty"`
	TimesheetMailNextdate                       *Time       `xmlrpc:"timesheet_mail_nextdate,omitempty" json:"timesheet_mail_nextdate,omitempty"`
	...
	UsesDefaultLogo                             *Bool       `xmlrpc:"uses_default_logo,omitempty" json:"uses_default_logo,omitempty"`

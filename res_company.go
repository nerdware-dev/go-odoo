...
type ResCompany struct {
	...
	AccountDashboardOnboardingState          *Selection `xmlrpc:"account_dashboard_onboarding_state,omitempty" json:"account_dashboard_onboarding_state,omitempty"`
	AccountDefaultPosReceivableAccountId     *Many2One  `xmlrpc:"account_default_pos_receivable_account_id,omitempty" json:"account_default_pos_receivable_account_id,omitempty"`
	AccountFolder                            *Many2One  `xmlrpc:"account_folder,omitempty" json:"account_folder,omitempty"`
	AccountInvoiceOnboardingState            *Selection `xmlrpc:"account_invoice_onboarding_state,omitempty" json:"account_invoice_onboarding_state,omitempty"`
	AccountNo                                *String    `xmlrpc:"account_no,omitempty" json:"account_no,omitempty"`
	AccountOnboardingInvoiceLayoutState      *Selection `xmlrpc:"account_onboarding_invoice_layout_state,omitempty" json:"account_onboarding_invoice_layout_state,omitempty"`
	AccountOnboardingSaleTaxState            *Selection `xmlrpc:"account_onboarding_sale_tax_state,omitempty" json:"account_onboarding_sale_tax_state,omitempty"`
	AccountOnboardingSampleInvoiceState      *Selection `xmlrpc:"account_onboarding_sample_invoice_state,omitempty" json:"account_onboarding_sample_invoice_state,omitempty"`
	AccountOpeningDate                       *Time      `xmlrpc:"account_opening_date,omitempty" json:"account_opening_date,omitempty"`
	AccountOpeningJournalId                  *Many2One  `xmlrpc:"account_opening_journal_id,omitempty" json:"account_opening_journal_id,omitempty"`
	AccountOpeningMoveId                     *Many2One  `xmlrpc:"account_opening_move_id,omitempty" json:"account_opening_move_id,omitempty"`
	AccountPurchaseTaxId                     *Many2One  `xmlrpc:"account_purchase_tax_id,omitempty" json:"account_purchase_tax_id,omitempty"`
	AccountSaleTaxId                         *Many2One  `xmlrpc:"account_sale_tax_id,omitempty" json:"account_sale_tax_id,omitempty"`
	AccountSetupBankDataState                *Selection `xmlrpc:"account_setup_bank_data_state,omitempty" json:"account_setup_bank_data_state,omitempty"`
	AccountSetupCoaState                     *Selection `xmlrpc:"account_setup_coa_state,omitempty" json:"account_setup_coa_state,omitempty"`
	AccountSetupFyDataState                  *Selection `xmlrpc:"account_setup_fy_data_state,omitempty" json:"account_setup_fy_data_state,omitempty"`
	AccountTaxNextActivityType               *Many2One  `xmlrpc:"account_tax_next_activity_type,omitempty" json:"account_tax_next_activity_type,omitempty"`
	AccountTaxOriginalPeriodicityReminderDay *Int       `xmlrpc:"account_tax_original_periodicity_reminder_day,omitempty" json:"account_tax_original_periodicity_reminder_day,omitempty"`
	...
	AccrualDefaultJournalId                  *Many2One  `xmlrpc:"accrual_default_journal_id,omitempty" json:"accrual_default_journal_id,omitempty"`
	AngloSaxonAccounting                     *Bool      `xmlrpc:"anglo_saxon_accounting,omitempty" json:"anglo_saxon_accounting,omitempty"`
	...
	BaseOnboardingCompanyState               *Selection `xmlrpc:"base_onboarding_company_state,omitempty" json:"base_onboarding_company_state,omitempty"`
	CashAccountCodePrefix                    *String    `xmlrpc:"cash_account_code_prefix,omitempty" json:"cash_account_code_prefix,omitempty"`
	Catchall                                 *String    `xmlrpc:"catchall,omitempty" json:"catchall,omitempty"`
	ChartTemplateId                          *Many2One  `xmlrpc:"chart_template_id,omitempty" json:"chart_template_id,omitempty"`
	ChiefExecutiveOfficer                    *String    `xmlrpc:"chief_executive_officer,omitempty" json:"chief_executive_officer,omitempty"`
	...
	DefaultCashDifferenceExpenseAccountId    *Many2One  `xmlrpc:"default_cash_difference_expense_account_id,omitempty" json:"default_cash_difference_expense_account_id,omitempty"`
	DefaultCashDifferenceIncomeAccountId     *Many2One  `xmlrpc:"default_cash_difference_income_account_id,omitempty" json:"default_cash_difference_income_account_id,omitempty"`
	...
	ExpectsChartOfAccounts                   *Bool      `xmlrpc:"expects_chart_of_accounts,omitempty" json:"expects_chart_of_accounts,omitempty"`
	ExpenseAccrualAccountId                  *Many2One  `xmlrpc:"expense_accrual_account_id,omitempty" json:"expense_accrual_account_id,omitempty"`
	...
	HasReceivedWarningStockSms               *Bool      `xmlrpc:"has_received_warning_stock_sms,omitempty" json:"has_received_warning_stock_sms,omitempty"`
	...
	InternalTransitLocationId                *Many2One  `xmlrpc:"internal_transit_location_id,omitempty" json:"internal_transit_location_id,omitempty"`
	IntrastatRegionId                        *Many2One  `xmlrpc:"intrastat_region_id,omitempty" json:"intrastat_region_id,omitempty"`
	IntrastatTransportModeId                 *Many2One  `xmlrpc:"intrastat_transport_mode_id,omitempty" json:"intrastat_transport_mode_id,omitempty"`
	...
	L10NDeDatevClientNumber                  *String    `xmlrpc:"l10n_de_datev_client_number,omitempty" json:"l10n_de_datev_client_number,omitempty"`
	L10NDeDatevConsultantNumber              *String    `xmlrpc:"l10n_de_datev_consultant_number,omitempty" json:"l10n_de_datev_consultant_number,omitempty"`
	...
	LogoWeb                                  *String    `xmlrpc:"logo_web,omitempty" json:"logo_web,omitempty"`
	LossAccountId                            *Many2One  `xmlrpc:"loss_account_id,omitempty" json:"loss_account_id,omitempty"`
	LunchMinimumThreshold                    *Float     `xmlrpc:"lunch_minimum_threshold,omitempty" json:"lunch_minimum_threshold,omitempty"`
	MinExtraHour                             *Int       `xmlrpc:"min_extra_hour,omitempty" json:"min_extra_hour,omitempty"`
	Name                                     *String    `xmlrpc:"name,omitempty" json:"name,omitempty"`
	NomenclatureId                           *Many2One  `xmlrpc:"nomenclature_id,omitempty" json:"nomenclature_id,omitempty"`
	...
	PaymentAcquirerOnboardingState           *Selection `xmlrpc:"payment_acquirer_onboarding_state,omitempty" json:"payment_acquirer_onboarding_state,omitempty"`
	PaymentOnboardingPaymentMethod           *Selection `xmlrpc:"payment_onboarding_payment_method,omitempty" json:"payment_onboarding_payment_method,omitempty"`
	...
	RentalLocId                              *Many2One  `xmlrpc:"rental_loc_id,omitempty" json:"rental_loc_id,omitempty"`
	...
	ResourceCalendarIds                      *Relation  `xmlrpc:"resource_calendar_ids,omitempty" json:"resource_calendar_ids,omitempty"`
	RevenueAccrualAccountId                  *Many2One  `xmlrpc:"revenue_accrual_account_id,omitempty" json:"revenue_accrual_account_id,omitempty"`
	SaleOnboardingOrderConfirmationState     *Selection `xmlrpc:"sale_onboarding_order_confirmation_state,omitempty" json:"sale_onboarding_order_confirmation_state,omitempty"`
	...
	SaleOnboardingSampleQuotationState       *Selection `xmlrpc:"sale_onboarding_sample_quotation_state,omitempty" json:"sale_onboarding_sample_quotation_state,omitempty"`
	SaleQuotationOnboardingState             *Selection `xmlrpc:"sale_quotation_onboarding_state,omitempty" json:"sale_quotation_onboarding_state,omitempty"`
	...
	TimesheetMailEmployeeAllow               *Bool      `xmlrpc:"timesheet_mail_employee_allow,omitempty" json:"timesheet_mail_employee_allow,omitempty"`
	TimesheetMailEmployeeDelay               *Int       `xmlrpc:"timesheet_mail_employee_delay,omitempty" json:"timesheet_mail_employee_delay,omitempty"`
	TimesheetMailEmployeeInterval            *Selection `xmlrpc:"timesheet_mail_employee_interval,omitempty" json:"timesheet_mail_employee_interval,omitempty"`
	TimesheetMailEmployeeNextdate            *Time      `xmlrpc:"timesheet_mail_employee_nextdate,omitempty" json:"timesheet_mail_employee_nextdate,omitempty"`
	TimesheetMailManagerAllow                *Bool      `xmlrpc:"timesheet_mail_manager_allow,omitempty" json:"timesheet_mail_manager_allow,omitempty"`
	TimesheetMailManagerDelay                *Int       `xmlrpc:"timesheet_mail_manager_delay,omitempty" json:"timesheet_mail_manager_delay,omitempty"`
	TimesheetMailManagerInterval             *Selection `xmlrpc:"timesheet_mail_manager_interval,omitempty" json:"timesheet_mail_manager_interval,omitempty"`
	TimesheetMailManagerNextdate             *Time      `xmlrpc:"timesheet_mail_manager_nextdate,omitempty" json:"timesheet_mail_manager_nextdate,omitempty"`
	TotalsBelowSections                      *Bool      `xmlrpc:"totals_below_sections,omitempty" json:"totals_below_sections,omitempty"`
	TransferAccountCodePrefix                *String    `xmlrpc:"transfer_account_code_prefix,omitempty" json:"transfer_account_code_prefix,omitempty"`
	...
	WebsiteThemeOnboardingDone               *Bool      `xmlrpc:"website_theme_onboarding_done,omitempty" json:"website_theme_onboarding_done,omitempty"`
	WriteDate                                *Time      `xmlrpc:"write_date,omitempty" json:"write_date,omitempty"`
	WriteUid                                 *Many2One  `xmlrpc:"write_uid,omitempty" json:"write_uid,omitempty"`
	YodleeAccessToken                        *String    `xmlrpc:"yodlee_access_token,omitempty" json:"yodlee_access_token,omitempty"`
	YodleeUserAccessToken                    *String    `xmlrpc:"yodlee_user_access_token,omitempty" json:"yodlee_user_access_token,omitempty"`
	YodleeUserLogin                          *String    `xmlrpc:"yodlee_user_login,omitempty" json:"yodlee_user_login,omitempty"`
	YodleeUserPassword                       *String    `xmlrpc:"yodlee_user_password,omitempty" json:"yodlee_user_password,omitempty"`

...
type ResCompany struct {
	...
	AccountEdiProxyClientIds                    *Relation   `xmlrpc:"account_edi_proxy_client_ids,omitempty" json:"account_edi_proxy_client_ids,omitempty"`
	...
	BatchPaymentSequenceId                      *Many2One   `xmlrpc:"batch_payment_sequence_id,omitempty" json:"batch_payment_sequence_id,omitempty"`
	...
	CompanyRegistryPlaceholder                  *String     `xmlrpc:"company_registry_placeholder,omitempty" json:"company_registry_placeholder,omitempty"`
	CompanyVatPlaceholder                       *String     `xmlrpc:"company_vat_placeholder,omitempty" json:"company_vat_placeholder,omitempty"`
	...
	HardLockDate                                *Time       `xmlrpc:"hard_lock_date,omitempty" json:"hard_lock_date,omitempty"`
	HasMessage                                  *Bool       `xmlrpc:"has_message,omitempty" json:"has_message,omitempty"`
	HrPresenceControlAttendance                 *Bool       `xmlrpc:"hr_presence_control_attendance,omitempty" json:"hr_presence_control_attendance,omitempty"`
	...
	IapEnrichAutoDone                           *Bool       `xmlrpc:"iap_enrich_auto_done,omitempty" json:"iap_enrich_auto_done,omitempty"`
	...
	PeppolPurchaseJournalId                     *Many2One   `xmlrpc:"peppol_purchase_journal_id,omitempty" json:"peppol_purchase_journal_id,omitempty"`
	...
	PurchaseLockDate                            *Time       `xmlrpc:"purchase_lock_date,omitempty" json:"purchase_lock_date,omitempty"`
	...
	SaleLockDate                                *Time       `xmlrpc:"sale_lock_date,omitempty" json:"sale_lock_date,omitempty"`
	...
	UninstalledL10NModuleIds                    *Relation   `xmlrpc:"uninstalled_l10n_module_ids,omitempty" json:"uninstalled_l10n_module_ids,omitempty"`
	UserFiscalyearLockDate                      *Time       `xmlrpc:"user_fiscalyear_lock_date,omitempty" json:"user_fiscalyear_lock_date,omitempty"`
	UserHardLockDate                            *Time       `xmlrpc:"user_hard_lock_date,omitempty" json:"user_hard_lock_date,omitempty"`
	UserIds                                     *Relation   `xmlrpc:"user_ids,omitempty" json:"user_ids,omitempty"`
	UserPurchaseLockDate                        *Time       `xmlrpc:"user_purchase_lock_date,omitempty" json:"user_purchase_lock_date,omitempty"`
	UserSaleLockDate                            *Time       `xmlrpc:"user_sale_lock_date,omitempty" json:"user_sale_lock_date,omitempty"`
	UserTaxLockDate                             *Time       `xmlrpc:"user_tax_lock_date,omitempty" json:"user_tax_lock_date,omitempty"`

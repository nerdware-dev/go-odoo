...
type AccountEdiProxyClientUser struct {
	...
	EdiIdentification      *String    `xmlrpc:"edi_identification,omitempty" json:"edi_identification,omitempty"`
	EdiMode                *Selection `xmlrpc:"edi_mode,omitempty" json:"edi_mode,omitempty"`
	Id                     *Int       `xmlrpc:"id,omitempty" json:"id,omitempty"`
	IdClient               *String    `xmlrpc:"id_client,omitempty" json:"id_client,omitempty"`
	PeppolVerificationCode *String    `xmlrpc:"peppol_verification_code,omitempty" json:"peppol_verification_code,omitempty"`
	PrivateKeyId           *Many2One  `xmlrpc:"private_key_id,omitempty" json:"private_key_id,omitempty"`
	ProxyType              *Selection `xmlrpc:"proxy_type,omitempty" json:"proxy_type,omitempty"`

...
func (c *Client) CreateThemeUtilss(tus []*ThemeUtils) ([]int64, error) {
	...
	return c.Create(ThemeUtilsModel, vv)
}
...
func (c *Client) FindThemeUtils(criteria *Criteria) (*ThemeUtils, error) {
	...
	return nil, fmt.Errorf("theme.utils was not found with criteria %v", criteria)
}
...
func (c *Client) FindThemeUtilsId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("theme.utils was not found with criteria %v and options %v", criteria, options)
}

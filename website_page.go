...
type WebsitePage struct {
	...
	DatePublish            *Time      `xmlrpc:"date_publish,omitempty" json:"date_publish,omitempty"`
	...
	HeaderColor            *String    `xmlrpc:"header_color,omitempty" json:"header_color,omitempty"`
	HeaderOverlay          *Bool      `xmlrpc:"header_overlay,omitempty" json:"header_overlay,omitempty"`
	...
	IsHomepage             *Bool      `xmlrpc:"is_homepage,omitempty" json:"is_homepage,omitempty"`
	...
	MenuIds                *Relation  `xmlrpc:"menu_ids,omitempty" json:"menu_ids,omitempty"`
	...
	WebsiteIndexed         *Bool      `xmlrpc:"website_indexed,omitempty" json:"website_indexed,omitempty"`

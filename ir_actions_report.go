...
type IrActionsReport struct {
	Attachment       *String    `xmlrpc:"attachment,omitempty" json:"attachment,omitempty"`
	AttachmentUse    *Bool      `xmlrpc:"attachment_use,omitempty" json:"attachment_use,omitempty"`
	...
	ReportType       *Selection `xmlrpc:"report_type,omitempty" json:"report_type,omitempty"`

...
type AccountPeppolService struct {
	...
	DocumentIdentifier *String   `xmlrpc:"document_identifier,omitempty" json:"document_identifier,omitempty"`
	DocumentName       *String   `xmlrpc:"document_name,omitempty" json:"document_name,omitempty"`

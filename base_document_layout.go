...
func (c *Client) CreateBaseDocumentLayouts(bdls []*BaseDocumentLayout) ([]int64, error) {
	...
	return c.Create(BaseDocumentLayoutModel, vv)
}
...
func (c *Client) FindBaseDocumentLayout(criteria *Criteria) (*BaseDocumentLayout, error) {
	...
	return nil, fmt.Errorf("base.document.layout was not found with criteria %v", criteria)
}
...
func (c *Client) FindBaseDocumentLayoutId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("base.document.layout was not found with criteria %v and options %v", criteria, options)
}

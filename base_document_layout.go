...
type BaseDocumentLayout struct {
	...
	FromInvoice             *Bool      `xmlrpc:"from_invoice,omitempty" json:"from_invoice,omitempty"`
	Id                      *Int       `xmlrpc:"id,omitempty" json:"id,omitempty"`
	IsCompanyDetailsEmpty   *Bool      `xmlrpc:"is_company_details_empty,omitempty" json:"is_company_details_empty,omitempty"`
	L10NDin5008DeliveryDate *Time      `xmlrpc:"l10n_din5008_delivery_date,omitempty" json:"l10n_din5008_delivery_date,omitempty"`
	L10NDin5008DueDate      *Time      `xmlrpc:"l10n_din5008_due_date,omitempty" json:"l10n_din5008_due_date,omitempty"`
	L10NDin5008InvoiceDate  *Time      `xmlrpc:"l10n_din5008_invoice_date,omitempty" json:"l10n_din5008_invoice_date,omitempty"`

...
type AccountMergeWizard struct {
	...
	DisableMergeButton *Bool     `xmlrpc:"disable_merge_button,omitempty" json:"disable_merge_button,omitempty"`
	DisplayName        *String   `xmlrpc:"display_name,omitempty" json:"display_name,omitempty"`
	Id                 *Int      `xmlrpc:"id,omitempty" json:"id,omitempty"`
	IsGroupByName      *Bool     `xmlrpc:"is_group_by_name,omitempty" json:"is_group_by_name,omitempty"`
	WizardLineIds      *Relation `xmlrpc:"wizard_line_ids,omitempty" json:"wizard_line_ids,omitempty"`

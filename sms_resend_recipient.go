...
func (c *Client) CreateSmsResendRecipients(srrs []*SmsResendRecipient) ([]int64, error) {
	...
	return c.Create(SmsResendRecipientModel, vv)
}
...
func (c *Client) FindSmsResendRecipient(criteria *Criteria) (*SmsResendRecipient, error) {
	...
	return nil, fmt.Errorf("sms.resend.recipient was not found with criteria %v", criteria)
}
...
func (c *Client) FindSmsResendRecipientId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("sms.resend.recipient was not found with criteria %v and options %v", criteria, options)
}

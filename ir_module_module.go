...
type IrModuleModule struct {
	AccountTemplates *String    `xmlrpc:"account_templates,omitempty" json:"account_templates,omitempty"`
	...
	HasIap           *Bool      `xmlrpc:"has_iap,omitempty" json:"has_iap,omitempty"`
	Icon             *String    `xmlrpc:"icon,omitempty" json:"icon,omitempty"`
	IconFlag         *String    `xmlrpc:"icon_flag,omitempty" json:"icon_flag,omitempty"`
	...
	ModuleType       *Selection `xmlrpc:"module_type,omitempty" json:"module_type,omitempty"`

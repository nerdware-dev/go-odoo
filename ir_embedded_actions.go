...
type IrEmbeddedActions struct {
	...
	DefaultViewMode *String   `xmlrpc:"default_view_mode,omitempty" json:"default_view_mode,omitempty"`
	...
	GroupsIds       *Relation `xmlrpc:"groups_ids,omitempty" json:"groups_ids,omitempty"`
	Id              *Int      `xmlrpc:"id,omitempty" json:"id,omitempty"`
	IsDeletable     *Bool     `xmlrpc:"is_deletable,omitempty" json:"is_deletable,omitempty"`
	IsVisible       *Bool     `xmlrpc:"is_visible,omitempty" json:"is_visible,omitempty"`
	Name            *String   `xmlrpc:"name,omitempty" json:"name,omitempty"`
	ParentActionId  *Many2One `xmlrpc:"parent_action_id,omitempty" json:"parent_action_id,omitempty"`
	...
	PythonMethod    *String   `xmlrpc:"python_method,omitempty" json:"python_method,omitempty"`

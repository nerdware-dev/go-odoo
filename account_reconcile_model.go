...
type AccountReconcileModel struct {
	...
	AmountFromLabelRegex       *String    `xmlrpc:"amount_from_label_regex,omitempty" json:"amount_from_label_regex,omitempty"`
	...
	ForceSecondTaxIncluded     *Bool      `xmlrpc:"force_second_tax_included,omitempty" json:"force_second_tax_included,omitempty"`
	ForceTaxIncluded           *Bool      `xmlrpc:"force_tax_included,omitempty" json:"force_tax_included,omitempty"`
	HasSecondLine              *Bool      `xmlrpc:"has_second_line,omitempty" json:"has_second_line,omitempty"`
	...
	MatchTotalAmount           *Bool      `xmlrpc:"match_total_amount,omitempty" json:"match_total_amount,omitempty"`
	MatchTotalAmountParam      *Float     `xmlrpc:"match_total_amount_param,omitempty" json:"match_total_amount_param,omitempty"`
	...
	SecondAccountId            *Many2One  `xmlrpc:"second_account_id,omitempty" json:"second_account_id,omitempty"`
	SecondAmount               *Float     `xmlrpc:"second_amount,omitempty" json:"second_amount,omitempty"`
	SecondAmountFromLabelRegex *String    `xmlrpc:"second_amount_from_label_regex,omitempty" json:"second_amount_from_label_regex,omitempty"`
	SecondAmountType           *Selection `xmlrpc:"second_amount_type,omitempty" json:"second_amount_type,omitempty"`
	SecondAnalyticAccountId    *Many2One  `xmlrpc:"second_analytic_account_id,omitempty" json:"second_analytic_account_id,omitempty"`
	SecondAnalyticTagIds       *Relation  `xmlrpc:"second_analytic_tag_ids,omitempty" json:"second_analytic_tag_ids,omitempty"`
	SecondJournalId            *Many2One  `xmlrpc:"second_journal_id,omitempty" json:"second_journal_id,omitempty"`
	SecondLabel                *String    `xmlrpc:"second_label,omitempty" json:"second_label,omitempty"`
	SecondTaxIds               *Relation  `xmlrpc:"second_tax_ids,omitempty" json:"second_tax_ids,omitempty"`
	Sequence                   *Int       `xmlrpc:"sequence,omitempty" json:"sequence,omitempty"`
	ShowForceTaxIncluded       *Bool      `xmlrpc:"show_force_tax_included,omitempty" json:"show_force_tax_included,omitempty"`
	ShowSecondForceTaxIncluded *Bool      `xmlrpc:"show_second_force_tax_included,omitempty" json:"show_second_force_tax_included,omitempty"`

...
type PaymentLinkWizard struct {
	...
	AmountMax               *Float      `xmlrpc:"amount_max,omitempty" json:"amount_max,omitempty"`
	AmountPaid              *Float      `xmlrpc:"amount_paid,omitempty" json:"amount_paid,omitempty"`
	CompanyId               *Many2One   `xmlrpc:"company_id,omitempty" json:"company_id,omitempty"`
	ConfirmationMessage     *String     `xmlrpc:"confirmation_message,omitempty" json:"confirmation_message,omitempty"`
	...
	DisplayOpenInstallments *Bool       `xmlrpc:"display_open_installments,omitempty" json:"display_open_installments,omitempty"`
	EpdInfo                 *String     `xmlrpc:"epd_info,omitempty" json:"epd_info,omitempty"`
	HasEligibleEpd          *Bool       `xmlrpc:"has_eligible_epd,omitempty" json:"has_eligible_epd,omitempty"`
	Id                      *Int        `xmlrpc:"id,omitempty" json:"id,omitempty"`
	InvoiceAmountDue        *Float      `xmlrpc:"invoice_amount_due,omitempty" json:"invoice_amount_due,omitempty"`
	Link                    *String     `xmlrpc:"link,omitempty" json:"link,omitempty"`
	OpenInstallments        interface{} `xmlrpc:"open_installments,omitempty" json:"open_installments,omitempty"`
	OpenInstallmentsPreview *String     `xmlrpc:"open_installments_preview,omitempty" json:"open_installments_preview,omitempty"`

...
func (c *Client) CreateIrQwebFieldMany2Manys(iqfms []*IrQwebFieldMany2Many) ([]int64, error) {
	...
	return c.Create(IrQwebFieldMany2ManyModel, vv, nil)
}
...
func (c *Client) UpdateIrQwebFieldMany2Manys(ids []int64, iqfm *IrQwebFieldMany2Many) error {
	return c.Update(IrQwebFieldMany2ManyModel, ids, iqfm, nil)
}
...
func (c *Client) FindIrQwebFieldMany2ManyIds(criteria *Criteria, options *Options) ([]int64, error) {
	return c.Search(IrQwebFieldMany2ManyModel, criteria, options)
}

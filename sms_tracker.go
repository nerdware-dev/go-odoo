...
type SmsTracker struct {
	...
	MailNotificationId *Many2One `xmlrpc:"mail_notification_id,omitempty" json:"mail_notification_id,omitempty"`
	SmsUuid            *String   `xmlrpc:"sms_uuid,omitempty" json:"sms_uuid,omitempty"`

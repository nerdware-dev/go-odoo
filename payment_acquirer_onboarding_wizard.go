...
func (c *Client) CreatePaymentAcquirerOnboardingWizards(paows []*PaymentAcquirerOnboardingWizard) ([]int64, error) {
	...
	return c.Create(PaymentAcquirerOnboardingWizardModel, vv, nil)
}
...
func (c *Client) UpdatePaymentAcquirerOnboardingWizards(ids []int64, paow *PaymentAcquirerOnboardingWizard) error {
	return c.Update(PaymentAcquirerOnboardingWizardModel, ids, paow, nil)
}
...
func (c *Client) FindPaymentAcquirerOnboardingWizardIds(criteria *Criteria, options *Options) ([]int64, error) {
	return c.Search(PaymentAcquirerOnboardingWizardModel, criteria, options)
}

...
type AccountMoveSendWizard struct {
	Alerts                   interface{} `xmlrpc:"alerts,omitempty" json:"alerts,omitempty"`
	AttachmentsNotSupported  interface{} `xmlrpc:"attachments_not_supported,omitempty" json:"attachments_not_supported,omitempty"`
	CompanyId                *Many2One   `xmlrpc:"company_id,omitempty" json:"company_id,omitempty"`
	CreateDate               *Time       `xmlrpc:"create_date,omitempty" json:"create_date,omitempty"`
	CreateUid                *Many2One   `xmlrpc:"create_uid,omitempty" json:"create_uid,omitempty"`
	DisplayAttachmentsWidget *Bool       `xmlrpc:"display_attachments_widget,omitempty" json:"display_attachments_widget,omitempty"`
	DisplayName              *String     `xmlrpc:"display_name,omitempty" json:"display_name,omitempty"`
	DisplayPdfReportId       *Bool       `xmlrpc:"display_pdf_report_id,omitempty" json:"display_pdf_report_id,omitempty"`
	ExtraEdiCheckboxes       interface{} `xmlrpc:"extra_edi_checkboxes,omitempty" json:"extra_edi_checkboxes,omitempty"`
	ExtraEdis                interface{} `xmlrpc:"extra_edis,omitempty" json:"extra_edis,omitempty"`
	Id                       *Int        `xmlrpc:"id,omitempty" json:"id,omitempty"`
	InvoiceEdiFormat         *Selection  `xmlrpc:"invoice_edi_format,omitempty" json:"invoice_edi_format,omitempty"`
	IsDownloadOnly           *Bool       `xmlrpc:"is_download_only,omitempty" json:"is_download_only,omitempty"`
	...
	PdfReportId              *Many2One   `xmlrpc:"pdf_report_id,omitempty" json:"pdf_report_id,omitempty"`
	SendingMethodCheckboxes  interface{} `xmlrpc:"sending_method_checkboxes,omitempty" json:"sending_method_checkboxes,omitempty"`
	SendingMethods           interface{} `xmlrpc:"sending_methods,omitempty" json:"sending_methods,omitempty"`

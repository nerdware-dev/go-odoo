...
type CrmLeadPlsUpdate struct {
	...
	PlsFields    *Relation `xmlrpc:"pls_fields,omitempty" json:"pls_fields,omitempty"`
	PlsStartDate *Time     `xmlrpc:"pls_start_date,omitempty" json:"pls_start_date,omitempty"`

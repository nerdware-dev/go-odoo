...
type StockValuationLayer struct {
	...
	AccountMoveLineId      *Many2One `xmlrpc:"account_move_line_id,omitempty" json:"account_move_line_id,omitempty"`
	...
	PriceDiffValue         *Float    `xmlrpc:"price_diff_value,omitempty" json:"price_diff_value,omitempty"`

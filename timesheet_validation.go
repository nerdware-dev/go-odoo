...
type TimesheetValidation struct {
	...
	ValidationDate    *Time     `xmlrpc:"validation_date,omitempty" json:"validation_date,omitempty"`
	ValidationLineIds *Relation `xmlrpc:"validation_line_ids,omitempty" json:"validation_line_ids,omitempty"`

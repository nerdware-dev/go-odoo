...
type IapService struct {
	...
	IntegerBalance *Bool     `xmlrpc:"integer_balance,omitempty" json:"integer_balance,omitempty"`
	Name           *String   `xmlrpc:"name,omitempty" json:"name,omitempty"`
	TechnicalName  *String   `xmlrpc:"technical_name,omitempty" json:"technical_name,omitempty"`
	UnitName       *String   `xmlrpc:"unit_name,omitempty" json:"unit_name,omitempty"`

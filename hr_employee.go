...
type HrEmployee struct {
	...
	IsFlexible                  *Bool       `xmlrpc:"is_flexible,omitempty" json:"is_flexible,omitempty"`
	IsFullyFlexible             *Bool       `xmlrpc:"is_fully_flexible,omitempty" json:"is_fully_flexible,omitempty"`
	...
	RelatedPartnersCount        *Int        `xmlrpc:"related_partners_count,omitempty" json:"related_partners_count,omitempty"`

...
type HrEmployee struct {
	...
	DocumentsShareId            *Many2One   `xmlrpc:"documents_share_id,omitempty"`
	...
	HoursPreviouslyToday        *Float      `xmlrpc:"hours_previously_today,omitempty"`
	...
	LastAttendanceWorkedHours   *Float      `xmlrpc:"last_attendance_worked_hours,omitempty"`
	...
	OvertimeIds                 *Relation   `xmlrpc:"overtime_ids,omitempty"`

...
type HrEmployee struct {
	...
	DocumentsShareId            *Many2One   `xmlrpc:"documents_share_id,omitempty" json:"documents_share_id,omitempty"`
	...
	HasTimesheet                *Bool       `xmlrpc:"has_timesheet,omitempty" json:"has_timesheet,omitempty"`
	HasWorkPermit               *String     `xmlrpc:"has_work_permit,omitempty" json:"has_work_permit,omitempty"`
	HourlyCost                  *Float      `xmlrpc:"hourly_cost,omitempty" json:"hourly_cost,omitempty"`
	...
	HoursPreviouslyToday        *Float      `xmlrpc:"hours_previously_today,omitempty" json:"hours_previously_today,omitempty"`
	...
	IdCard                      *String     `xmlrpc:"id_card,omitempty" json:"id_card,omitempty"`
	...
	LastAttendanceWorkedHours   *Float      `xmlrpc:"last_attendance_worked_hours,omitempty" json:"last_attendance_worked_hours,omitempty"`
	...
	LastValidatedTimesheetDate  *Time       `xmlrpc:"last_validated_timesheet_date,omitempty" json:"last_validated_timesheet_date,omitempty"`
	...
	OvertimeIds                 *Relation   `xmlrpc:"overtime_ids,omitempty" json:"overtime_ids,omitempty"`
	...
	PrivateCarPlate             *String     `xmlrpc:"private_car_plate,omitempty" json:"private_car_plate,omitempty"`
	...
	SkillIds                    *Relation   `xmlrpc:"skill_ids,omitempty" json:"skill_ids,omitempty"`
	...
	WorkPermitExpirationDate    *Time       `xmlrpc:"work_permit_expiration_date,omitempty" json:"work_permit_expiration_date,omitempty"`
	WorkPermitName              *String     `xmlrpc:"work_permit_name,omitempty" json:"work_permit_name,omitempty"`
	WorkPermitScheduledActivity *Bool       `xmlrpc:"work_permit_scheduled_activity,omitempty" json:"work_permit_scheduled_activity,omitempty"`

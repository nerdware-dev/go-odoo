...
type PurchaseBillLineMatch struct {
	...
	AmlId                 *Many2One `xmlrpc:"aml_id,omitempty" json:"aml_id,omitempty"`
	BilledAmountUntaxed   *Float    `xmlrpc:"billed_amount_untaxed,omitempty" json:"billed_amount_untaxed,omitempty"`
	CompanyId             *Many2One `xmlrpc:"company_id,omitempty" json:"company_id,omitempty"`
	CurrencyId            *Many2One `xmlrpc:"currency_id,omitempty" json:"currency_id,omitempty"`
	DisplayName           *String   `xmlrpc:"display_name,omitempty" json:"display_name,omitempty"`
	Id                    *Int      `xmlrpc:"id,omitempty" json:"id,omitempty"`
	LineAmountUntaxed     *Float    `xmlrpc:"line_amount_untaxed,omitempty" json:"line_amount_untaxed,omitempty"`
	LineQty               *Float    `xmlrpc:"line_qty,omitempty" json:"line_qty,omitempty"`
	LineUomId             *Many2One `xmlrpc:"line_uom_id,omitempty" json:"line_uom_id,omitempty"`
	PartnerId             *Many2One `xmlrpc:"partner_id,omitempty" json:"partner_id,omitempty"`
	PolId                 *Many2One `xmlrpc:"pol_id,omitempty" json:"pol_id,omitempty"`
	ProductId             *Many2One `xmlrpc:"product_id,omitempty" json:"product_id,omitempty"`
	ProductUomId          *Many2One `xmlrpc:"product_uom_id,omitempty" json:"product_uom_id,omitempty"`
	ProductUomPrice       *Float    `xmlrpc:"product_uom_price,omitempty" json:"product_uom_price,omitempty"`
	ProductUomQty         *Float    `xmlrpc:"product_uom_qty,omitempty" json:"product_uom_qty,omitempty"`
	PurchaseAmountUntaxed *Float    `xmlrpc:"purchase_amount_untaxed,omitempty" json:"purchase_amount_untaxed,omitempty"`
	...
	State                 *String   `xmlrpc:"state,omitempty" json:"state,omitempty"`
}

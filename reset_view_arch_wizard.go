...
func (c *Client) CreateResetViewArchWizards(rvaws []*ResetViewArchWizard) ([]int64, error) {
	...
	return c.Create(ResetViewArchWizardModel, vv, nil)
}
...
func (c *Client) UpdateResetViewArchWizards(ids []int64, rvaw *ResetViewArchWizard) error {
	return c.Update(ResetViewArchWizardModel, ids, rvaw, nil)
}
...
func (c *Client) FindResetViewArchWizardIds(criteria *Criteria, options *Options) ([]int64, error) {
	return c.Search(ResetViewArchWizardModel, criteria, options)
}

...
type StockWarehouse struct {
	...
	BuyPullId          *Many2One  `xmlrpc:"buy_pull_id,omitempty" json:"buy_pull_id,omitempty"`
	BuyToResupply      *Bool      `xmlrpc:"buy_to_resupply,omitempty" json:"buy_to_resupply,omitempty"`
	...
	CrossdockRouteId   *Many2One  `xmlrpc:"crossdock_route_id,omitempty" json:"crossdock_route_id,omitempty"`
	DeliveryRouteId    *Many2One  `xmlrpc:"delivery_route_id,omitempty" json:"delivery_route_id,omitempty"`
	DeliverySteps      *Selection `xmlrpc:"delivery_steps,omitempty" json:"delivery_steps,omitempty"`
	DisplayName        *String    `xmlrpc:"display_name,omitempty" json:"display_name,omitempty"`
	Id                 *Int       `xmlrpc:"id,omitempty" json:"id,omitempty"`
	InTypeId           *Many2One  `xmlrpc:"in_type_id,omitempty" json:"in_type_id,omitempty"`
	IntTypeId          *Many2One  `xmlrpc:"int_type_id,omitempty" json:"int_type_id,omitempty"`
	IntrastatRegionId  *Many2One  `xmlrpc:"intrastat_region_id,omitempty" json:"intrastat_region_id,omitempty"`
	LotStockId         *Many2One  `xmlrpc:"lot_stock_id,omitempty" json:"lot_stock_id,omitempty"`
	MtoPullId          *Many2One  `xmlrpc:"mto_pull_id,omitempty" json:"mto_pull_id,omitempty"`
	Name               *String    `xmlrpc:"name,omitempty" json:"name,omitempty"`
	OutTypeId          *Many2One  `xmlrpc:"out_type_id,omitempty" json:"out_type_id,omitempty"`
	PackTypeId         *Many2One  `xmlrpc:"pack_type_id,omitempty" json:"pack_type_id,omitempty"`
	PartnerId          *Many2One  `xmlrpc:"partner_id,omitempty" json:"partner_id,omitempty"`
	PickTypeId         *Many2One  `xmlrpc:"pick_type_id,omitempty" json:"pick_type_id,omitempty"`
	ReceptionRouteId   *Many2One  `xmlrpc:"reception_route_id,omitempty" json:"reception_route_id,omitempty"`
	ReceptionSteps     *Selection `xmlrpc:"reception_steps,omitempty" json:"reception_steps,omitempty"`
	ResupplyRouteIds   *Relation  `xmlrpc:"resupply_route_ids,omitempty" json:"resupply_route_ids,omitempty"`
	ResupplyWhIds      *Relation  `xmlrpc:"resupply_wh_ids,omitempty" json:"resupply_wh_ids,omitempty"`
	RouteIds           *Relation  `xmlrpc:"route_ids,omitempty" json:"route_ids,omitempty"`
	Sequence           *Int       `xmlrpc:"sequence,omitempty" json:"sequence,omitempty"`
	ShowResupply       *Bool      `xmlrpc:"show_resupply,omitempty" json:"show_resupply,omitempty"`
	ViewLocationId     *Many2One  `xmlrpc:"view_location_id,omitempty" json:"view_location_id,omitempty"`
	WarehouseCount     *Int       `xmlrpc:"warehouse_count,omitempty" json:"warehouse_count,omitempty"`
	WhInputStockLocId  *Many2One  `xmlrpc:"wh_input_stock_loc_id,omitempty" json:"wh_input_stock_loc_id,omitempty"`
	WhOutputStockLocId *Many2One  `xmlrpc:"wh_output_stock_loc_id,omitempty" json:"wh_output_stock_loc_id,omitempty"`
	WhPackStockLocId   *Many2One  `xmlrpc:"wh_pack_stock_loc_id,omitempty" json:"wh_pack_stock_loc_id,omitempty"`
	WhQcStockLocId     *Many2One  `xmlrpc:"wh_qc_stock_loc_id,omitempty" json:"wh_qc_stock_loc_id,omitempty"`

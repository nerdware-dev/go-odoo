...
type MailTemplate struct {
	...
	IsTemplateEditor  *Bool      `xmlrpc:"is_template_editor,omitempty" json:"is_template_editor,omitempty"`
	...
	ReportTemplateIds *Relation  `xmlrpc:"report_template_ids,omitempty" json:"report_template_ids,omitempty"`
	...
	TemplateCategory  *Selection `xmlrpc:"template_category,omitempty" json:"template_category,omitempty"`

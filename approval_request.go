...
type ApprovalRequest struct {
	...
	ApproverIds                 *Relation  `xmlrpc:"approver_ids,omitempty" json:"approver_ids,omitempty"`
	...
	DateConfirmed               *Time      `xmlrpc:"date_confirmed,omitempty" json:"date_confirmed,omitempty"`
	...
	HasAccessToRequest          *Bool      `xmlrpc:"has_access_to_request,omitempty" json:"has_access_to_request,omitempty"`
	...
	Items                       *String    `xmlrpc:"items,omitempty" json:"items,omitempty"`
	...
	RequestOwnerId              *Many2One  `xmlrpc:"request_owner_id,omitempty" json:"request_owner_id,omitempty"`
	RequestStatus               *Selection `xmlrpc:"request_status,omitempty" json:"request_status,omitempty"`
	RequirerDocument            *Selection `xmlrpc:"requirer_document,omitempty" json:"requirer_document,omitempty"`
	UserStatus                  *Selection `xmlrpc:"user_status,omitempty" json:"user_status,omitempty"`

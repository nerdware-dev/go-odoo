...
type AccountLockException struct {
	...
	CompanyLockDate    *Time      `xmlrpc:"company_lock_date,omitempty" json:"company_lock_date,omitempty"`
	...
	LockDate           *Time      `xmlrpc:"lock_date,omitempty" json:"lock_date,omitempty"`
	LockDateField      *Selection `xmlrpc:"lock_date_field,omitempty" json:"lock_date_field,omitempty"`

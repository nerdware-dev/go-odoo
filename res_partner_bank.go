...
type ResPartnerBank struct {
	...
	AllowOutPayment                 *Bool      `xmlrpc:"allow_out_payment,omitempty" json:"allow_out_payment,omitempty"`
	...
	LockTrustFields                 *Bool      `xmlrpc:"lock_trust_fields,omitempty" json:"lock_trust_fields,omitempty"`
	...
	MoneyTransferService            *String    `xmlrpc:"money_transfer_service,omitempty" json:"money_transfer_service,omitempty"`
	MyActivityDateDeadline          *Time      `xmlrpc:"my_activity_date_deadline,omitempty" json:"my_activity_date_deadline,omitempty"`
	PartnerCountryName              *String    `xmlrpc:"partner_country_name,omitempty" json:"partner_country_name,omitempty"`
	PartnerCustomerRank             *Int       `xmlrpc:"partner_customer_rank,omitempty" json:"partner_customer_rank,omitempty"`
	PartnerId                       *Many2One  `xmlrpc:"partner_id,omitempty" json:"partner_id,omitempty"`
	PartnerSupplierRank             *Int       `xmlrpc:"partner_supplier_rank,omitempty" json:"partner_supplier_rank,omitempty"`
	RatingIds                       *Relation  `xmlrpc:"rating_ids,omitempty" json:"rating_ids,omitempty"`
	RelatedMoves                    *Relation  `xmlrpc:"related_moves,omitempty" json:"related_moves,omitempty"`
	SanitizedAccNumber              *String    `xmlrpc:"sanitized_acc_number,omitempty" json:"sanitized_acc_number,omitempty"`
	Sequence                        *Int       `xmlrpc:"sequence,omitempty" json:"sequence,omitempty"`
	UserHasGroupValidateBankAccount *Bool      `xmlrpc:"user_has_group_validate_bank_account,omitempty" json:"user_has_group_validate_bank_account,omitempty"`

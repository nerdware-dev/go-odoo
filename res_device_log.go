...
type ResDeviceLog struct {
	Browser           *String    `xmlrpc:"browser,omitempty" json:"browser,omitempty"`
	City              *String    `xmlrpc:"city,omitempty" json:"city,omitempty"`
	Country           *String    `xmlrpc:"country,omitempty" json:"country,omitempty"`
	CreateDate        *Time      `xmlrpc:"create_date,omitempty" json:"create_date,omitempty"`
	CreateUid         *Many2One  `xmlrpc:"create_uid,omitempty" json:"create_uid,omitempty"`
	DeviceType        *Selection `xmlrpc:"device_type,omitempty" json:"device_type,omitempty"`
	DisplayName       *String    `xmlrpc:"display_name,omitempty" json:"display_name,omitempty"`
	FirstActivity     *Time      `xmlrpc:"first_activity,omitempty" json:"first_activity,omitempty"`
	Id                *Int       `xmlrpc:"id,omitempty" json:"id,omitempty"`
	IpAddress         *String    `xmlrpc:"ip_address,omitempty" json:"ip_address,omitempty"`
	IsCurrent         *Bool      `xmlrpc:"is_current,omitempty" json:"is_current,omitempty"`
	LastActivity      *Time      `xmlrpc:"last_activity,omitempty" json:"last_activity,omitempty"`
	LinkedIpAddresses *String    `xmlrpc:"linked_ip_addresses,omitempty" json:"linked_ip_addresses,omitempty"`
	Platform          *String    `xmlrpc:"platform,omitempty" json:"platform,omitempty"`
	Revoked           *Bool      `xmlrpc:"revoked,omitempty" json:"revoked,omitempty"`
	SessionIdentifier *String    `xmlrpc:"session_identifier,omitempty" json:"session_identifier,omitempty"`

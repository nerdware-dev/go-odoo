...
type ProductCombo struct {
	BasePrice      *Float    `xmlrpc:"base_price,omitempty" json:"base_price,omitempty"`
	ComboItemCount *Int      `xmlrpc:"combo_item_count,omitempty" json:"combo_item_count,omitempty"`
	ComboItemIds   *Relation `xmlrpc:"combo_item_ids,omitempty" json:"combo_item_ids,omitempty"`

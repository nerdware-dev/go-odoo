...
type StockPackageType struct {
	...
	BaseWeight                 *Float    `xmlrpc:"base_weight,omitempty" json:"base_weight,omitempty"`
	...
	LengthUomName              *String   `xmlrpc:"length_uom_name,omitempty" json:"length_uom_name,omitempty"`
	MaxWeight                  *Float    `xmlrpc:"max_weight,omitempty" json:"max_weight,omitempty"`
	Name                       *String   `xmlrpc:"name,omitempty" json:"name,omitempty"`
	PackagingLength            *Float    `xmlrpc:"packaging_length,omitempty" json:"packaging_length,omitempty"`

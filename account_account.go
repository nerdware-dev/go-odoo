...
type AccountAccount struct {
	...
	CodeMappingIds           *Relation  `xmlrpc:"code_mapping_ids,omitempty" json:"code_mapping_ids,omitempty"`
	CodeStore                *String    `xmlrpc:"code_store,omitempty" json:"code_store,omitempty"`
	CompanyCurrencyId        *Many2One  `xmlrpc:"company_currency_id,omitempty" json:"company_currency_id,omitempty"`
	CompanyFiscalCountryCode *String    `xmlrpc:"company_fiscal_country_code,omitempty" json:"company_fiscal_country_code,omitempty"`
	...
	DisplayMappingTab        *Bool      `xmlrpc:"display_mapping_tab,omitempty" json:"display_mapping_tab,omitempty"`
	...
	PlaceholderCode          *String    `xmlrpc:"placeholder_code,omitempty" json:"placeholder_code,omitempty"`

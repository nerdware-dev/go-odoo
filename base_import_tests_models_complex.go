...
func (c *Client) CreateBaseImportTestsModelsComplexs(btmcs []*BaseImportTestsModelsComplex) ([]int64, error) {
	...
	return c.Create(BaseImportTestsModelsComplexModel, vv, nil)
}
...
func (c *Client) UpdateBaseImportTestsModelsComplexs(ids []int64, btmc *BaseImportTestsModelsComplex) error {
	return c.Update(BaseImportTestsModelsComplexModel, ids, btmc, nil)
}
...
func (c *Client) FindBaseImportTestsModelsComplexIds(criteria *Criteria, options *Options) ([]int64, error) {
	return c.Search(BaseImportTestsModelsComplexModel, criteria, options)
}

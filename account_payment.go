...
type AccountPayment struct {
	...
	DestinationJournalId        *Many2One  `xmlrpc:"destination_journal_id,omitempty" json:"destination_journal_id,omitempty"`
	DisplayName                 *String    `xmlrpc:"display_name,omitempty" json:"display_name,omitempty"`
	DisplayQrCode               *Bool      `xmlrpc:"display_qr_code,omitempty" json:"display_qr_code,omitempty"`
	HasInvoices                 *Bool      `xmlrpc:"has_invoices,omitempty" json:"has_invoices,omitempty"`
	...
	MoveReconciled              *Bool      `xmlrpc:"move_reconciled,omitempty" json:"move_reconciled,omitempty"`
	...
	QrCodeUrl                   *String    `xmlrpc:"qr_code_url,omitempty" json:"qr_code_url,omitempty"`

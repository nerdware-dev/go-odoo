...
type AccountPayment struct {
	...
	QrCodeUrl                   *String    `xmlrpc:"qr_code_url,omitempty"`
	...
	SddMandateId                *Many2One  `xmlrpc:"sdd_mandate_id,omitempty"`
	SddMandateUsable            *Bool      `xmlrpc:"sdd_mandate_usable,omitempty"`

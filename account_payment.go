...
type AccountPayment struct {
	...
	L10NDin5008Addresses                  *String     `xmlrpc:"l10n_din5008_addresses,omitempty"`
	...
	PaymentMethodName                     *String     `xmlrpc:"payment_method_name,omitempty"`
	...
	TaxClosingShowMultiClosingWarning     *Bool       `xmlrpc:"tax_closing_show_multi_closing_warning,omitempty"`

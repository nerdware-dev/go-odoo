...
type AccountPayment struct {
	...
	IsInternalTransfer                    *Bool       `xmlrpc:"is_internal_transfer,omitempty" json:"is_internal_transfer,omitempty"`
	...
	PaymentMethodName                     *String     `xmlrpc:"payment_method_name,omitempty" json:"payment_method_name,omitempty"`

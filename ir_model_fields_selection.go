...
func (c *Client) CreateIrModelFieldsSelections(imfss []*IrModelFieldsSelection) ([]int64, error) {
	...
	return c.Create(IrModelFieldsSelectionModel, vv, nil)
}
...
func (c *Client) UpdateIrModelFieldsSelections(ids []int64, imfs *IrModelFieldsSelection) error {
	return c.Update(IrModelFieldsSelectionModel, ids, imfs, nil)
}
...
func (c *Client) FindIrModelFieldsSelectionIds(criteria *Criteria, options *Options) ([]int64, error) {
	return c.Search(IrModelFieldsSelectionModel, criteria, options)
}

...
type AccountMoveSendBatchWizard struct {
	...
	SendByPostStamps *Int        `xmlrpc:"send_by_post_stamps,omitempty" json:"send_by_post_stamps,omitempty"`
	SummaryData      interface{} `xmlrpc:"summary_data,omitempty" json:"summary_data,omitempty"`

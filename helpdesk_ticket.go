...
type HelpdeskTicket struct {
	...
	AssignDate                  *Time      `xmlrpc:"assign_date,omitempty" json:"assign_date,omitempty"`
	AssignHours                 *Int       `xmlrpc:"assign_hours,omitempty" json:"assign_hours,omitempty"`
	...
	CloseDate                   *Time      `xmlrpc:"close_date,omitempty" json:"close_date,omitempty"`
	CloseHours                  *Int       `xmlrpc:"close_hours,omitempty" json:"close_hours,omitempty"`
	ClosedByPartner             *Bool      `xmlrpc:"closed_by_partner,omitempty" json:"closed_by_partner,omitempty"`
	...
	ForumPostId                 *Many2One  `xmlrpc:"forum_post_id,omitempty" json:"forum_post_id,omitempty"`
	Id                          *Int       `xmlrpc:"id,omitempty" json:"id,omitempty"`
	IsClosed                    *Bool      `xmlrpc:"is_closed,omitempty" json:"is_closed,omitempty"`
	IsOverdue                   *Bool      `xmlrpc:"is_overdue,omitempty" json:"is_overdue,omitempty"`
	IsSelfAssigned              *Bool      `xmlrpc:"is_self_assigned,omitempty" json:"is_self_assigned,omitempty"`
	IsTaskActive                *Bool      `xmlrpc:"is_task_active,omitempty" json:"is_task_active,omitempty"`
	...
	OpenHours                   *Int       `xmlrpc:"open_hours,omitempty" json:"open_hours,omitempty"`
	...
	PartnerTicketCount          *Int       `xmlrpc:"partner_ticket_count,omitempty" json:"partner_ticket_count,omitempty"`
	PickingIds                  *Relation  `xmlrpc:"picking_ids,omitempty" json:"picking_ids,omitempty"`
	PickingsCount               *Int       `xmlrpc:"pickings_count,omitempty" json:"pickings_count,omitempty"`
	...
	SlaFail                     *Bool      `xmlrpc:"sla_fail,omitempty" json:"sla_fail,omitempty"`
	SlaIds                      *Relation  `xmlrpc:"sla_ids,omitempty" json:"sla_ids,omitempty"`
	SlaReachedLate              *Bool      `xmlrpc:"sla_reached_late,omitempty" json:"sla_reached_late,omitempty"`
	SlaStatusIds                *Relation  `xmlrpc:"sla_status_ids,omitempty" json:"sla_status_ids,omitempty"`

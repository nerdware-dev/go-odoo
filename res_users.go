...
type ResUsers struct {
	...
	AttendanceManagerId                *Many2One  `xmlrpc:"attendance_manager_id,omitempty"`
	...
	DisplayExtraHours                  *Bool      `xmlrpc:"display_extra_hours,omitempty"`
	...
	L10NDeDatevIdentifierCustomer      *Int       `xmlrpc:"l10n_de_datev_identifier_customer,omitempty"`
	...
	RequestOvertime                    *Bool      `xmlrpc:"request_overtime,omitempty"`
	...
	TotalOvertime                      *Float     `xmlrpc:"total_overtime,omitempty"`

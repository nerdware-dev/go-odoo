...
func (c *Client) CreateProductAttributeCustomValues(pacvs []*ProductAttributeCustomValue) ([]int64, error) {
	...
	return c.Create(ProductAttributeCustomValueModel, vv, nil)
}
...
func (c *Client) UpdateProductAttributeCustomValues(ids []int64, pacv *ProductAttributeCustomValue) error {
	return c.Update(ProductAttributeCustomValueModel, ids, pacv, nil)
}
...
func (c *Client) FindProductAttributeCustomValueIds(criteria *Criteria, options *Options) ([]int64, error) {
	return c.Search(ProductAttributeCustomValueModel, criteria, options)
}

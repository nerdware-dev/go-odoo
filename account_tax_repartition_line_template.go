...
type AccountTaxRepartitionLineTemplate struct {
	...
	InvoiceTaxId       *Many2One  `xmlrpc:"invoice_tax_id,omitempty" json:"invoice_tax_id,omitempty"`
	MinusReportLineIds *Relation  `xmlrpc:"minus_report_line_ids,omitempty" json:"minus_report_line_ids,omitempty"`
	PlusReportLineIds  *Relation  `xmlrpc:"plus_report_line_ids,omitempty" json:"plus_report_line_ids,omitempty"`
	RefundTaxId        *Many2One  `xmlrpc:"refund_tax_id,omitempty" json:"refund_tax_id,omitempty"`

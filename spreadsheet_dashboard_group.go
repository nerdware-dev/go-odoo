...
type SpreadsheetDashboardGroup struct {
	...
	DashboardIds          *Relation `xmlrpc:"dashboard_ids,omitempty" json:"dashboard_ids,omitempty"`
	DisplayName           *String   `xmlrpc:"display_name,omitempty" json:"display_name,omitempty"`
	Id                    *Int      `xmlrpc:"id,omitempty" json:"id,omitempty"`
	Name                  *String   `xmlrpc:"name,omitempty" json:"name,omitempty"`
	PublishedDashboardIds *Relation `xmlrpc:"published_dashboard_ids,omitempty" json:"published_dashboard_ids,omitempty"`

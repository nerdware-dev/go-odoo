...
type AccountPaymentRegister struct {
	ActionableErrors              interface{} `xmlrpc:"actionable_errors,omitempty" json:"actionable_errors,omitempty"`
	...
	Batches                       *String     `xmlrpc:"batches,omitempty" json:"batches,omitempty"`
	CanEditWizard                 *Bool       `xmlrpc:"can_edit_wizard,omitempty" json:"can_edit_wizard,omitempty"`
	CanGroupPayments              *Bool       `xmlrpc:"can_group_payments,omitempty" json:"can_group_payments,omitempty"`
	...
	CustomUserAmount              *Float      `xmlrpc:"custom_user_amount,omitempty" json:"custom_user_amount,omitempty"`
	CustomUserCurrencyId          *Many2One   `xmlrpc:"custom_user_currency_id,omitempty" json:"custom_user_currency_id,omitempty"`
	DisplayName                   *String     `xmlrpc:"display_name,omitempty" json:"display_name,omitempty"`
	DuplicatePaymentIds           *Relation   `xmlrpc:"duplicate_payment_ids,omitempty" json:"duplicate_payment_ids,omitempty"`
	EarlyPaymentDiscountMode      *Bool       `xmlrpc:"early_payment_discount_mode,omitempty" json:"early_payment_discount_mode,omitempty"`
	GroupPayment                  *Bool       `xmlrpc:"group_payment,omitempty" json:"group_payment,omitempty"`
	HideWriteoffSection           *Bool       `xmlrpc:"hide_writeoff_section,omitempty" json:"hide_writeoff_section,omitempty"`
	Id                            *Int        `xmlrpc:"id,omitempty" json:"id,omitempty"`
	InstallmentsMode              *Selection  `xmlrpc:"installments_mode,omitempty" json:"installments_mode,omitempty"`
	InstallmentsSwitchAmount      *Float      `xmlrpc:"installments_switch_amount,omitempty" json:"installments_switch_amount,omitempty"`
	InstallmentsSwitchHtml        *String     `xmlrpc:"installments_switch_html,omitempty" json:"installments_switch_html,omitempty"`
	IsRegisterPaymentOnDraft      *Bool       `xmlrpc:"is_register_payment_on_draft,omitempty" json:"is_register_payment_on_draft,omitempty"`
	...
	MissingAccountPartners        *Relation   `xmlrpc:"missing_account_partners,omitempty" json:"missing_account_partners,omitempty"`
	...
	PaymentDifference             *Float      `xmlrpc:"payment_difference,omitempty" json:"payment_difference,omitempty"`
	PaymentDifferenceHandling     *Selection  `xmlrpc:"payment_difference_handling,omitempty" json:"payment_difference_handling,omitempty"`
	...
	ShowPaymentDifference         *Bool       `xmlrpc:"show_payment_difference,omitempty" json:"show_payment_difference,omitempty"`
	SourceAmount                  *Float      `xmlrpc:"source_amount,omitempty" json:"source_amount,omitempty"`
	SourceAmountCurrency          *Float      `xmlrpc:"source_amount_currency,omitempty" json:"source_amount_currency,omitempty"`
	SourceCurrencyId              *Many2One   `xmlrpc:"source_currency_id,omitempty" json:"source_currency_id,omitempty"`
	SuitablePaymentTokenIds       *Relation   `xmlrpc:"suitable_payment_token_ids,omitempty" json:"suitable_payment_token_ids,omitempty"`
	TotalPaymentsAmount           *Int        `xmlrpc:"total_payments_amount,omitempty" json:"total_payments_amount,omitempty"`
	UntrustedBankIds              *Relation   `xmlrpc:"untrusted_bank_ids,omitempty" json:"untrusted_bank_ids,omitempty"`
	UntrustedPaymentsCount        *Int        `xmlrpc:"untrusted_payments_count,omitempty" json:"untrusted_payments_count,omitempty"`
	...
	WriteoffAccountId             *Many2One   `xmlrpc:"writeoff_account_id,omitempty" json:"writeoff_account_id,omitempty"`
	WriteoffIsExchangeAccount     *Bool       `xmlrpc:"writeoff_is_exchange_account,omitempty" json:"writeoff_is_exchange_account,omitempty"`
	WriteoffLabel                 *String     `xmlrpc:"writeoff_label,omitempty" json:"writeoff_label,omitempty"`
}

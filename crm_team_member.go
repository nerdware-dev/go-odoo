...
type CrmTeamMember struct {
	...
	CrmTeamId                *Many2One `xmlrpc:"crm_team_id,omitempty" json:"crm_team_id,omitempty"`
	...
	UserInTeamsIds           *Relation `xmlrpc:"user_in_teams_ids,omitempty" json:"user_in_teams_ids,omitempty"`

...
type UomUom struct {
	...
	TimesheetWidget *String    `xmlrpc:"timesheet_widget,omptempty"`
...
func (c *Client) CreateUomUoms(uus []*UomUom) ([]int64, error) {
	...
	return c.Create(UomUomModel, vv)
}
...
func (c *Client) FindUomUom(criteria *Criteria) (*UomUom, error) {
	...
	return nil, fmt.Errorf("uom.uom was not found with criteria %v", criteria)
}
...
func (c *Client) FindUomUomId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("uom.uom was not found with criteria %v and options %v", criteria, options)
}

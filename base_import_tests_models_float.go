...
func (c *Client) CreateBaseImportTestsModelsFloats(btmfs []*BaseImportTestsModelsFloat) ([]int64, error) {
	...
	return c.Create(BaseImportTestsModelsFloatModel, vv, nil)
}
...
func (c *Client) UpdateBaseImportTestsModelsFloats(ids []int64, btmf *BaseImportTestsModelsFloat) error {
	return c.Update(BaseImportTestsModelsFloatModel, ids, btmf, nil)
}
...
func (c *Client) FindBaseImportTestsModelsFloatIds(criteria *Criteria, options *Options) ([]int64, error) {
	return c.Search(BaseImportTestsModelsFloatModel, criteria, options)
}

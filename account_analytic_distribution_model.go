...
type AccountAnalyticDistributionModel struct {
	...
	PartnerCategoryId              *Many2One   `xmlrpc:"partner_category_id,omitempty" json:"partner_category_id,omitempty"`
	PartnerId                      *Many2One   `xmlrpc:"partner_id,omitempty" json:"partner_id,omitempty"`
	PrefixPlaceholder              *String     `xmlrpc:"prefix_placeholder,omitempty" json:"prefix_placeholder,omitempty"`

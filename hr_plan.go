...
func (c *Client) CreateHrPlans(hps []*HrPlan) ([]int64, error) {
	...
	return c.Create(HrPlanModel, vv)
}
...
func (c *Client) FindHrPlan(criteria *Criteria) (*HrPlan, error) {
	...
	return nil, fmt.Errorf("hr.plan was not found with criteria %v", criteria)
}
...
func (c *Client) FindHrPlanId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("hr.plan was not found with criteria %v and options %v", criteria, options)
}

...
type HrApplicant struct {
	...
	Availability                *Time      `xmlrpc:"availability,omitempty" json:"availability,omitempty"`
	...
	DelayClose                  *Float     `xmlrpc:"delay_close,omitempty" json:"delay_close,omitempty"`
	...
	EmpId                       *Many2One  `xmlrpc:"emp_id,omitempty" json:"emp_id,omitempty"`
	EmployeeName                *String    `xmlrpc:"employee_name,omitempty" json:"employee_name,omitempty"`
	...
	LastStageId                 *Many2One  `xmlrpc:"last_stage_id,omitempty" json:"last_stage_id,omitempty"`
	...
	SalaryExpected              *Float     `xmlrpc:"salary_expected,omitempty" json:"salary_expected,omitempty"`
	SalaryExpectedExtra         *String    `xmlrpc:"salary_expected_extra,omitempty" json:"salary_expected_extra,omitempty"`
	SalaryProposed              *Float     `xmlrpc:"salary_proposed,omitempty" json:"salary_proposed,omitempty"`
	SalaryProposedExtra         *String    `xmlrpc:"salary_proposed_extra,omitempty" json:"salary_proposed_extra,omitempty"`

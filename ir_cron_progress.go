...
type IrCronProgress struct {
	...
	CronId          *Many2One `xmlrpc:"cron_id,omitempty" json:"cron_id,omitempty"`
	Deactivate      *Bool     `xmlrpc:"deactivate,omitempty" json:"deactivate,omitempty"`
	DisplayName     *String   `xmlrpc:"display_name,omitempty" json:"display_name,omitempty"`
	Done            *Int      `xmlrpc:"done,omitempty" json:"done,omitempty"`
	Id              *Int      `xmlrpc:"id,omitempty" json:"id,omitempty"`
	Remaining       *Int      `xmlrpc:"remaining,omitempty" json:"remaining,omitempty"`
	TimedOutCounter *Int      `xmlrpc:"timed_out_counter,omitempty" json:"timed_out_counter,omitempty"`

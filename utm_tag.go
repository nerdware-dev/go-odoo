...
func (c *Client) CreateUtmTags(uts []*UtmTag) ([]int64, error) {
	...
	return c.Create(UtmTagModel, vv)
}
...
func (c *Client) FindUtmTag(criteria *Criteria) (*UtmTag, error) {
	...
	return nil, fmt.Errorf("utm.tag was not found with criteria %v", criteria)
}
...
func (c *Client) FindUtmTagId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("utm.tag was not found with criteria %v and options %v", criteria, options)
}

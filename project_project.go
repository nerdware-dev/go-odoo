...
type ProjectProject struct {
	...
	ExpensesCount                *Int        `xmlrpc:"expenses_count,omitempty"`
	...
	TotalBudgetProgress          *Float      `xmlrpc:"total_budget_progress,omitempty"`
	TotalPlannedAmount           *Float      `xmlrpc:"total_planned_amount,omitempty"`
	TotalPracticalAmount         *Float      `xmlrpc:"total_practical_amount,omitempty"`
	...
	UseDocuments                 *Bool       `xmlrpc:"use_documents,omitempty"`

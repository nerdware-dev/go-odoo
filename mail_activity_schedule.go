...
type MailActivitySchedule struct {
	...
	PlanDate                 *Time      `xmlrpc:"plan_date,omitempty" json:"plan_date,omitempty"`
	PlanDepartmentFilterable *Bool      `xmlrpc:"plan_department_filterable,omitempty" json:"plan_department_filterable,omitempty"`
	...
	PlanSummary              *String    `xmlrpc:"plan_summary,omitempty" json:"plan_summary,omitempty"`

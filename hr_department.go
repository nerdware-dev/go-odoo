...
type HrDepartment struct {
	...
	AbsenceOfToday              *Int      `xmlrpc:"absence_of_today,omitempty" json:"absence_of_today,omitempty"`
	Active                      *Bool     `xmlrpc:"active,omitempty" json:"active,omitempty"`
	AllocationToApproveCount    *Int      `xmlrpc:"allocation_to_approve_count,omitempty" json:"allocation_to_approve_count,omitempty"`
	...
	ExpectedEmployee            *Int      `xmlrpc:"expected_employee,omitempty" json:"expected_employee,omitempty"`
	...
	LeaveToApproveCount         *Int      `xmlrpc:"leave_to_approve_count,omitempty" json:"leave_to_approve_count,omitempty"`
	...
	NewApplicantCount           *Int      `xmlrpc:"new_applicant_count,omitempty" json:"new_applicant_count,omitempty"`
	NewHiredEmployee            *Int      `xmlrpc:"new_hired_employee,omitempty" json:"new_hired_employee,omitempty"`

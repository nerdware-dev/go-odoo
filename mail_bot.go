...
func (c *Client) CreateMailBots(mbs []*MailBot) ([]int64, error) {
	...
	return c.Create(MailBotModel, vv)
}
...
func (c *Client) FindMailBot(criteria *Criteria) (*MailBot, error) {
	...
	return nil, fmt.Errorf("mail.bot was not found with criteria %v", criteria)
}
...
func (c *Client) FindMailBotId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("mail.bot was not found with criteria %v and options %v", criteria, options)
}

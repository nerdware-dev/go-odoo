...
type SaleOrderLine struct {
	...
	IsProductRentable                 *Bool      `xmlrpc:"is_product_rentable,omptempty"`
	IsRental                          *Bool      `xmlrpc:"is_rental,omptempty"`
	...
	PurchasePrice                     *Float     `xmlrpc:"purchase_price,omptempty"`
	...
	RentalUpdatable                   *Bool      `xmlrpc:"rental_updatable,omptempty"`
	ReportComputeDate                 *Time      `xmlrpc:"report_compute_date,omptempty"`
	ReportLineIndex                   *Int       `xmlrpc:"report_line_index,omptempty"`
	ReservationBegin                  *Time      `xmlrpc:"reservation_begin,omptempty"`
	ReservedLotIds                    *Relation  `xmlrpc:"reserved_lot_ids,omptempty"`
	...
	UnavailableLotIds                 *Relation  `xmlrpc:"unavailable_lot_ids,omptempty"`

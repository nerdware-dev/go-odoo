...
type HrExpense struct {
	...
	IsRefEditable               *Bool      `xmlrpc:"is_ref_editable,omitempty" json:"is_ref_editable,omitempty"`
	IsRefused                   *Bool      `xmlrpc:"is_refused,omitempty" json:"is_refused,omitempty"`
	...
	TotalAmountCompany          *Float     `xmlrpc:"total_amount_company,omitempty" json:"total_amount_company,omitempty"`

...
type L10NEuServiceWizard struct {
	...
	AccountCollectedId *Many2One `xmlrpc:"account_collected_id,omptempty"`
	CompanyId          *Many2One `xmlrpc:"company_id,omptempty"`
	CreateDate         *Time     `xmlrpc:"create_date,omptempty"`
	CreateUid          *Many2One `xmlrpc:"create_uid,omptempty"`
	DisplayName        *String   `xmlrpc:"display_name,omptempty"`
	DoneCountryIds     *Relation `xmlrpc:"done_country_ids,omptempty"`
	FiscalPositionId   *Many2One `xmlrpc:"fiscal_position_id,omptempty"`
	Id                 *Int      `xmlrpc:"id,omptempty"`
	TaxId              *Many2One `xmlrpc:"tax_id,omptempty"`
	TodoCountryIds     *Relation `xmlrpc:"todo_country_ids,omptempty"`
...
func (c *Client) CreateL10NEuServiceWizards(lws []*L10NEuServiceWizard) ([]int64, error) {
	...
	return c.Create(L10NEuServiceWizardModel, vv)
}
...
func (c *Client) UpdateL10NEuServiceWizards(ids []int64, lw *L10NEuServiceWizard) error {
	return c.Update(L10NEuServiceWizardModel, ids, lw)
}
...
func (c *Client) GetL10NEuServiceWizard(id int64) (*L10NEuServiceWizard, error) {
	...
	if lws != nil && len(*lws) > 0 {
		return &((*lws)[0]), nil
	}
	return nil, fmt.Errorf("id %v of l10n_eu_service.wizard not found", id)
}
...
func (c *Client) FindL10NEuServiceWizard(criteria *Criteria) (*L10NEuServiceWizard, error) {
	...
	return nil, fmt.Errorf("l10n_eu_service.wizard was not found with criteria %v", criteria)
}
...
func (c *Client) FindL10NEuServiceWizardId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("l10n_eu_service.wizard was not found with criteria %v and options %v", criteria, options)
}

...
type PeppolRegistration struct {
	...
	ContactEmail              *String     `xmlrpc:"contact_email,omitempty" json:"contact_email,omitempty"`
	CreateDate                *Time       `xmlrpc:"create_date,omitempty" json:"create_date,omitempty"`
	CreateUid                 *Many2One   `xmlrpc:"create_uid,omitempty" json:"create_uid,omitempty"`
	DisplayName               *String     `xmlrpc:"display_name,omitempty" json:"display_name,omitempty"`
	EdiMode                   *Selection  `xmlrpc:"edi_mode,omitempty" json:"edi_mode,omitempty"`
	EdiModeConstraint         *Selection  `xmlrpc:"edi_mode_constraint,omitempty" json:"edi_mode_constraint,omitempty"`
	...
	PeppolWarnings            interface{} `xmlrpc:"peppol_warnings,omitempty" json:"peppol_warnings,omitempty"`
	PhoneNumber               *String     `xmlrpc:"phone_number,omitempty" json:"phone_number,omitempty"`
	SmpRegistration           *Bool       `xmlrpc:"smp_registration,omitempty" json:"smp_registration,omitempty"`
	VerificationCode          *String     `xmlrpc:"verification_code,omitempty" json:"verification_code,omitempty"`

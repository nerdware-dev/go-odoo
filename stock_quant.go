...
type StockQuant struct {
	...
	AvailableQuantity          *Float      `xmlrpc:"available_quantity,omitempty" json:"available_quantity,omitempty"`
	...
	InDate                     *Time       `xmlrpc:"in_date,omitempty" json:"in_date,omitempty"`
	InventoryDate              *Time       `xmlrpc:"inventory_date,omitempty" json:"inventory_date,omitempty"`
	InventoryDiffQuantity      *Float      `xmlrpc:"inventory_diff_quantity,omitempty" json:"inventory_diff_quantity,omitempty"`
	InventoryQuantity          *Float      `xmlrpc:"inventory_quantity,omitempty" json:"inventory_quantity,omitempty"`
	InventoryQuantityAutoApply *Float      `xmlrpc:"inventory_quantity_auto_apply,omitempty" json:"inventory_quantity_auto_apply,omitempty"`
	InventoryQuantitySet       *Bool       `xmlrpc:"inventory_quantity_set,omitempty" json:"inventory_quantity_set,omitempty"`
	IsOutdated                 *Bool       `xmlrpc:"is_outdated,omitempty" json:"is_outdated,omitempty"`
	LastCountDate              *Time       `xmlrpc:"last_count_date,omitempty" json:"last_count_date,omitempty"`
	...
	OnHand                     *Bool       `xmlrpc:"on_hand,omitempty" json:"on_hand,omitempty"`
	...
	ReservedQuantity           *Float      `xmlrpc:"reserved_quantity,omitempty" json:"reserved_quantity,omitempty"`
	SnDuplicated               *Bool       `xmlrpc:"sn_duplicated,omitempty" json:"sn_duplicated,omitempty"`

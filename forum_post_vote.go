...
type ForumPostVote struct {
	...
	PostId      *Many2One  `xmlrpc:"post_id,omitempty" json:"post_id,omitempty"`
	RecipientId *Many2One  `xmlrpc:"recipient_id,omitempty" json:"recipient_id,omitempty"`
	UserId      *Many2One  `xmlrpc:"user_id,omitempty" json:"user_id,omitempty"`
	Vote        *Selection `xmlrpc:"vote,omitempty" json:"vote,omitempty"`

...
type ForumPostVote struct {
	...
	RecipientId *Many2One  `xmlrpc:"recipient_id,omptempty"`
	UserId      *Many2One  `xmlrpc:"user_id,omptempty"`
	Vote        *Selection `xmlrpc:"vote,omptempty"`
...
func (c *Client) CreateForumPostVotes(fpvs []*ForumPostVote) ([]int64, error) {
	...
	return c.Create(ForumPostVoteModel, vv)
}
...
func (c *Client) UpdateForumPostVotes(ids []int64, fpv *ForumPostVote) error {
	return c.Update(ForumPostVoteModel, ids, fpv)
}
...
func (c *Client) GetForumPostVote(id int64) (*ForumPostVote, error) {
	...
	if fpvs != nil && len(*fpvs) > 0 {
		return &((*fpvs)[0]), nil
	}
	return nil, fmt.Errorf("id %v of forum.post.vote not found", id)
}
...
func (c *Client) FindForumPostVote(criteria *Criteria) (*ForumPostVote, error) {
	...
	return nil, fmt.Errorf("forum.post.vote was not found with criteria %v", criteria)
}
...
func (c *Client) FindForumPostVoteId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("forum.post.vote was not found with criteria %v and options %v", criteria, options)
}

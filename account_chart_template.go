...
type AccountChartTemplate struct {
	...
	CodeDigits                            *Int      `xmlrpc:"code_digits,omitempty" json:"code_digits,omitempty"`
	CompleteTaxSet                        *Bool     `xmlrpc:"complete_tax_set,omitempty" json:"complete_tax_set,omitempty"`
	...
	DefaultPosReceivableAccountId         *Many2One `xmlrpc:"default_pos_receivable_account_id,omitempty" json:"default_pos_receivable_account_id,omitempty"`
	...
	PropertyAdvanceTaxPaymentAccountId    *Many2One `xmlrpc:"property_advance_tax_payment_account_id,omitempty" json:"property_advance_tax_payment_account_id,omitempty"`
	...
	PropertyTaxPayableAccountId           *Many2One `xmlrpc:"property_tax_payable_account_id,omitempty" json:"property_tax_payable_account_id,omitempty"`
	PropertyTaxReceivableAccountId        *Many2One `xmlrpc:"property_tax_receivable_account_id,omitempty" json:"property_tax_receivable_account_id,omitempty"`
	TaxTemplateIds                        *Relation `xmlrpc:"tax_template_ids,omitempty" json:"tax_template_ids,omitempty"`

...
type IrFilters struct {
	...
	EmbeddedActionId    *Many2One  `xmlrpc:"embedded_action_id,omitempty" json:"embedded_action_id,omitempty"`
	EmbeddedParentResId *Int       `xmlrpc:"embedded_parent_res_id,omitempty" json:"embedded_parent_res_id,omitempty"`

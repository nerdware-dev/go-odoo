...
type AccountMove struct {
	AbnormalAmountWarning                 *String     `xmlrpc:"abnormal_amount_warning,omitempty" json:"abnormal_amount_warning,omitempty"`
	AbnormalDateWarning                   *String     `xmlrpc:"abnormal_date_warning,omitempty" json:"abnormal_date_warning,omitempty"`
	...
	AmountUntaxedInCurrencySigned         *Float      `xmlrpc:"amount_untaxed_in_currency_signed,omitempty" json:"amount_untaxed_in_currency_signed,omitempty"`
	...
	AuditTrailMessageIds                  *Relation   `xmlrpc:"audit_trail_message_ids,omitempty" json:"audit_trail_message_ids,omitempty"`
	...
	Checked                               *Bool       `xmlrpc:"checked,omitempty" json:"checked,omitempty"`
	...
	ExpectedCurrencyRate                  *Float      `xmlrpc:"expected_currency_rate,omitempty" json:"expected_currency_rate,omitempty"`
	...
	InvoiceCurrencyRate                   *Float      `xmlrpc:"invoice_currency_rate,omitempty" json:"invoice_currency_rate,omitempty"`
	...
	IsManuallyModified                    *Bool       `xmlrpc:"is_manually_modified,omitempty" json:"is_manually_modified,omitempty"`
	IsMoveSent                            *Bool       `xmlrpc:"is_move_sent,omitempty" json:"is_move_sent,omitempty"`
	IsPurchaseMatched                     *Bool       `xmlrpc:"is_purchase_matched,omitempty" json:"is_purchase_matched,omitempty"`
	IsStorno                              *Bool       `xmlrpc:"is_storno,omitempty" json:"is_storno,omitempty"`
	JournalGroupId                        *Many2One   `xmlrpc:"journal_group_id,omitempty" json:"journal_group_id,omitempty"`
	...
	MadeSequenceGap                       *Bool       `xmlrpc:"made_sequence_gap,omitempty" json:"made_sequence_gap,omitempty"`
	MatchedPaymentIds                     *Relation   `xmlrpc:"matched_payment_ids,omitempty" json:"matched_payment_ids,omitempty"`
	...
	MoveSentValues                        *Selection  `xmlrpc:"move_sent_values,omitempty" json:"move_sent_values,omitempty"`
	...
	NamePlaceholder                       *String     `xmlrpc:"name_placeholder,omitempty" json:"name_placeholder,omitempty"`
	...
	NextPaymentDate                       *Time       `xmlrpc:"next_payment_date,omitempty" json:"next_payment_date,omitempty"`
	OriginPaymentId                       *Many2One   `xmlrpc:"origin_payment_id,omitempty" json:"origin_payment_id,omitempty"`
	...
	PaymentCount                          *Int        `xmlrpc:"payment_count,omitempty" json:"payment_count,omitempty"`
	...
	PeppolMessageUuid                     *String     `xmlrpc:"peppol_message_uuid,omitempty" json:"peppol_message_uuid,omitempty"`
	PeppolMoveState                       *Selection  `xmlrpc:"peppol_move_state,omitempty" json:"peppol_move_state,omitempty"`
	PostedBefore                          *Bool       `xmlrpc:"posted_before,omitempty" json:"posted_before,omitempty"`
	PreferredPaymentMethodLineId          *Many2One   `xmlrpc:"preferred_payment_method_line_id,omitempty" json:"preferred_payment_method_line_id,omitempty"`
	...
	PurchaseOrderName                     *String     `xmlrpc:"purchase_order_name,omitempty" json:"purchase_order_name,omitempty"`
	...
	QuickEncodingVals                     interface{} `xmlrpc:"quick_encoding_vals,omitempty" json:"quick_encoding_vals,omitempty"`
	RatingIds                             *Relation   `xmlrpc:"rating_ids,omitempty" json:"rating_ids,omitempty"`
	ReconciledPaymentIds                  *Relation   `xmlrpc:"reconciled_payment_ids,omitempty" json:"reconciled_payment_ids,omitempty"`
	...
	ReversalMoveIds                       *Relation   `xmlrpc:"reversal_move_ids,omitempty" json:"reversal_move_ids,omitempty"`
	...
	Secured                               *Bool       `xmlrpc:"secured,omitempty" json:"secured,omitempty"`
	SendingData                           interface{} `xmlrpc:"sending_data,omitempty" json:"sending_data,omitempty"`
	...
	StatusInPayment                       *Selection  `xmlrpc:"status_in_payment,omitempty" json:"status_in_payment,omitempty"`
	...
	TaxesLegalNotes                       *String     `xmlrpc:"taxes_legal_notes,omitempty" json:"taxes_legal_notes,omitempty"`
	TeamId                                *Many2One   `xmlrpc:"team_id,omitempty" json:"team_id,omitempty"`
	TransactionCount                      *Int        `xmlrpc:"transaction_count,omitempty" json:"transaction_count,omitempty"`

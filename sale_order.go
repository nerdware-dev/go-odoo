...
type SaleOrder struct {
	...
	CompletedTaskPercentage      *Float      `xmlrpc:"completed_task_percentage,omitempty" json:"completed_task_percentage,omitempty"`
	...
	CustomizablePdfFormFields    interface{} `xmlrpc:"customizable_pdf_form_fields,omitempty" json:"customizable_pdf_form_fields,omitempty"`
	DateOrder                    *Time       `xmlrpc:"date_order,omitempty" json:"date_order,omitempty"`
	DisplayName                  *String     `xmlrpc:"display_name,omitempty" json:"display_name,omitempty"`
	DuplicatedOrderIds           *Relation   `xmlrpc:"duplicated_order_ids,omitempty" json:"duplicated_order_ids,omitempty"`
	...
	HasArchivedProducts          *Bool       `xmlrpc:"has_archived_products,omitempty" json:"has_archived_products,omitempty"`
	...
	IsPdfQuoteBuilderAvailable   *Bool       `xmlrpc:"is_pdf_quote_builder_available,omitempty" json:"is_pdf_quote_builder_available,omitempty"`
	...
	ProjectAccountId             *Many2One   `xmlrpc:"project_account_id,omitempty" json:"project_account_id,omitempty"`

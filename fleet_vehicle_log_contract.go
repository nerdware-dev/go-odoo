...
type FleetVehicleLogContract struct {
	...
	AutoGenerated               *Bool      `xmlrpc:"auto_generated,omitempty" json:"auto_generated,omitempty"`
	CompanyId                   *Many2One  `xmlrpc:"company_id,omitempty" json:"company_id,omitempty"`
	ContractId                  *Many2One  `xmlrpc:"contract_id,omitempty" json:"contract_id,omitempty"`
	CostAmount                  *Float     `xmlrpc:"cost_amount,omitempty" json:"cost_amount,omitempty"`
	...
	CostId                      *Many2One  `xmlrpc:"cost_id,omitempty" json:"cost_id,omitempty"`
	CostIds                     *Relation  `xmlrpc:"cost_ids,omitempty" json:"cost_ids,omitempty"`
	CostSubtypeId               *Many2One  `xmlrpc:"cost_subtype_id,omitempty" json:"cost_subtype_id,omitempty"`
	CostType                    *Selection `xmlrpc:"cost_type,omitempty" json:"cost_type,omitempty"`
	...
	GeneratedCostIds            *Relation  `xmlrpc:"generated_cost_ids,omitempty" json:"generated_cost_ids,omitempty"`
	...
	SumCost                     *Float     `xmlrpc:"sum_cost,omitempty" json:"sum_cost,omitempty"`

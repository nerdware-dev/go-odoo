...
type HrContract struct {
	...
	Advantages                  *String    `xmlrpc:"advantages,omitempty" json:"advantages,omitempty"`
	...
	TrialDateEnd                *Time      `xmlrpc:"trial_date_end,omitempty" json:"trial_date_end,omitempty"`

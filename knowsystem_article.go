...
type KnowsystemArticle struct {
	...
	ContributorIds              *Relation  `xmlrpc:"contributor_ids,omitempty" json:"contributor_ids,omitempty"`
	CreateDate                  *Time      `xmlrpc:"create_date,omitempty" json:"create_date,omitempty"`
	CreateUid                   *Many2One  `xmlrpc:"create_uid,omitempty" json:"create_uid,omitempty"`
	Description                 *String    `xmlrpc:"description,omitempty" json:"description,omitempty"`
	DescriptionArch             *String    `xmlrpc:"description_arch,omitempty" json:"description_arch,omitempty"`
	DislikeUserIds              *Relation  `xmlrpc:"dislike_user_ids,omitempty" json:"dislike_user_ids,omitempty"`
	DislikesNumber              *Int       `xmlrpc:"dislikes_number,omitempty" json:"dislikes_number,omitempty"`
	DisplayName                 *String    `xmlrpc:"display_name,omitempty" json:"display_name,omitempty"`
	FavouriteUserIds            *Relation  `xmlrpc:"favourite_user_ids,omitempty" json:"favourite_user_ids,omitempty"`
	Id                          *Int       `xmlrpc:"id,omitempty" json:"id,omitempty"`
	IndexedDescription          *String    `xmlrpc:"indexed_description,omitempty" json:"indexed_description,omitempty"`
	InternalUrl                 *String    `xmlrpc:"internal_url,omitempty" json:"internal_url,omitempty"`
	...
	KanbanDescription           *String    `xmlrpc:"kanban_description,omitempty" json:"kanban_description,omitempty"`
	KanbanManualDescription     *String    `xmlrpc:"kanban_manual_description,omitempty" json:"kanban_manual_description,omitempty"`
	LikeUserIds                 *Relation  `xmlrpc:"like_user_ids,omitempty" json:"like_user_ids,omitempty"`
	LikesNumber                 *Int       `xmlrpc:"likes_number,omitempty" json:"likes_number,omitempty"`
	LikesScore                  *Int       `xmlrpc:"likes_score,omitempty" json:"likes_score,omitempty"`
	...
	RevisionIds                 *Relation  `xmlrpc:"revision_ids,omitempty" json:"revision_ids,omitempty"`
	...
	ThisUserLikeState           *Selection `xmlrpc:"this_user_like_state,omitempty" json:"this_user_like_state,omitempty"`
	UsedInEmailCompose          *Int       `xmlrpc:"used_in_email_compose,omitempty" json:"used_in_email_compose,omitempty"`
	UserGroupIds                *Relation  `xmlrpc:"user_group_ids,omitempty" json:"user_group_ids,omitempty"`
	ViewStatIds                 *Relation  `xmlrpc:"view_stat_ids,omitempty" json:"view_stat_ids,omitempty"`
	ViewsNumberInternal         *Int       `xmlrpc:"views_number_internal,omitempty" json:"views_number_internal,omitempty"`
	...
	WriteRevisionDate           *Time      `xmlrpc:"write_revision_date,omitempty" json:"write_revision_date,omitempty"`
	WriteRevisionUid            *Many2One  `xmlrpc:"write_revision_uid,omitempty" json:"write_revision_uid,omitempty"`

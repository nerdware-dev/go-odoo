...
type ProjectUpdate struct {
	...
	NameCropped                 *String    `xmlrpc:"name_cropped,omitempty" json:"name_cropped,omitempty"`
	Progress                    *Int       `xmlrpc:"progress,omitempty" json:"progress,omitempty"`
	ProgressPercentage          *Float     `xmlrpc:"progress_percentage,omitempty" json:"progress_percentage,omitempty"`

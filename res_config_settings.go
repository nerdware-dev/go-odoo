...
type ResConfigSettings struct {
	...
	AccountBankReconciliationStart       *Time      `xmlrpc:"account_bank_reconciliation_start,omitempty" json:"account_bank_reconciliation_start,omitempty"`
	...
	CompanyLunchMinimumThreshold         *Float     `xmlrpc:"company_lunch_minimum_threshold,omitempty" json:"company_lunch_minimum_threshold,omitempty"`
	CompanyName                          *String    `xmlrpc:"company_name,omitempty" json:"company_name,omitempty"`
	ConfirmationTemplateId               *Many2One  `xmlrpc:"confirmation_template_id,omitempty" json:"confirmation_template_id,omitempty"`
	CreateDate                           *Time      `xmlrpc:"create_date,omitempty" json:"create_date,omitempty"`
	CreateUid                            *Many2One  `xmlrpc:"create_uid,omitempty" json:"create_uid,omitempty"`
	CrmAliasPrefix                       *String    `xmlrpc:"crm_alias_prefix,omitempty" json:"crm_alias_prefix,omitempty"`
	...
	DefaultSaleOrderTemplateId           *Many2One  `xmlrpc:"default_sale_order_template_id,omitempty" json:"default_sale_order_template_id,omitempty"`
	...
	DocumentsHrContractsTags             *Relation  `xmlrpc:"documents_hr_contracts_tags,omitempty" json:"documents_hr_contracts_tags,omitempty"`
	...
	DocumentsProjectSettings             *Bool      `xmlrpc:"documents_project_settings,omitempty" json:"documents_project_settings,omitempty"`
	DocumentsRecruitmentSettings         *Bool      `xmlrpc:"documents_recruitment_settings,omitempty" json:"documents_recruitment_settings,omitempty"`
	ExpenseAliasPrefix                   *String    `xmlrpc:"expense_alias_prefix,omitempty" json:"expense_alias_prefix,omitempty"`
	...
	ExtraDay                             *Float     `xmlrpc:"extra_day,omitempty" json:"extra_day,omitempty"`
	ExtraHour                            *Float     `xmlrpc:"extra_hour,omitempty" json:"extra_hour,omitempty"`
	ExtraProduct                         *Many2One  `xmlrpc:"extra_product,omitempty" json:"extra_product,omitempty"`
	...
	GenerateLeadFromAlias                *Bool      `xmlrpc:"generate_lead_from_alias,omitempty" json:"generate_lead_from_alias,omitempty"`
	...
	GroupAnalyticTags                    *Bool      `xmlrpc:"group_analytic_tags,omitempty" json:"group_analytic_tags,omitempty"`
	GroupAttendanceUsePin                *Bool      `xmlrpc:"group_attendance_use_pin,omitempty" json:"group_attendance_use_pin,omitempty"`
	...
	GroupDisplayIncoterm                 *Bool      `xmlrpc:"group_display_incoterm,omitempty" json:"group_display_incoterm,omitempty"`
	...
	GroupMassMailingCampaign             *Bool      `xmlrpc:"group_mass_mailing_campaign,omitempty" json:"group_mass_mailing_campaign,omitempty"`
	GroupMultiCurrency                   *Bool      `xmlrpc:"group_multi_currency,omitempty" json:"group_multi_currency,omitempty"`
	GroupMultiWebsite                    *Bool      `xmlrpc:"group_multi_website,omitempty" json:"group_multi_website,omitempty"`
	...
	GroupShowLineSubtotalsTaxExcluded    *Bool      `xmlrpc:"group_show_line_subtotals_tax_excluded,omitempty" json:"group_show_line_subtotals_tax_excluded,omitempty"`
	GroupShowLineSubtotalsTaxIncluded    *Bool      `xmlrpc:"group_show_line_subtotals_tax_included,omitempty" json:"group_show_line_subtotals_tax_included,omitempty"`
	...
	GroupStockMultiWarehouses            *Bool      `xmlrpc:"group_stock_multi_warehouses,omitempty" json:"group_stock_multi_warehouses,omitempty"`
	...
	GroupSubtaskProject                  *Bool      `xmlrpc:"group_subtask_project,omitempty" json:"group_subtask_project,omitempty"`
	...
	HasGoogleAnalytics                   *Bool      `xmlrpc:"has_google_analytics,omitempty" json:"has_google_analytics,omitempty"`
	HasGoogleAnalyticsDashboard          *Bool      `xmlrpc:"has_google_analytics_dashboard,omitempty" json:"has_google_analytics_dashboard,omitempty"`
	HasGoogleMaps                        *Bool      `xmlrpc:"has_google_maps,omitempty" json:"has_google_maps,omitempty"`
	HasSocialNetwork                     *Bool      `xmlrpc:"has_social_network,omitempty" json:"has_social_network,omitempty"`
	...
	InvoiceIsPrint                       *Bool      `xmlrpc:"invoice_is_print,omitempty" json:"invoice_is_print,omitempty"`
	...
	KnowsystemComposerOption             *Bool      `xmlrpc:"knowsystem_composer_option,omitempty" json:"knowsystem_composer_option,omitempty"`
	KnowsystemModelsOption               *Bool      `xmlrpc:"knowsystem_models_option,omitempty" json:"knowsystem_models_option,omitempty"`
	KnowsystemToursOption                *Bool      `xmlrpc:"knowsystem_tours_option,omitempty" json:"knowsystem_tours_option,omitempty"`
	KnowsystemTurnoffBackendEditor       *Bool      `xmlrpc:"knowsystem_turnoff_backend_editor,omitempty" json:"knowsystem_turnoff_backend_editor,omitempty"`
	KnowsystemWebsiteEditor              *Bool      `xmlrpc:"knowsystem_website_editor,omitempty" json:"knowsystem_website_editor,omitempty"`
	...
	LeaveTimesheetProjectId              *Many2One  `xmlrpc:"leave_timesheet_project_id,omitempty" json:"leave_timesheet_project_id,omitempty"`
	...
	MassMailingMailServerId              *Many2One  `xmlrpc:"mass_mailing_mail_server_id,omitempty" json:"mass_mailing_mail_server_id,omitempty"`
	MassMailingOutgoingMailServer        *Bool      `xmlrpc:"mass_mailing_outgoing_mail_server,omitempty" json:"mass_mailing_outgoing_mail_server,omitempty"`
	MinExtraHour                         *Int       `xmlrpc:"min_extra_hour,omitempty" json:"min_extra_hour,omitempty"`
	...
	ModuleAccountPlaid                   *Bool      `xmlrpc:"module_account_plaid,omitempty" json:"module_account_plaid,omitempty"`
	ModuleAccountPredictiveBills         *Bool      `xmlrpc:"module_account_predictive_bills,omitempty" json:"module_account_predictive_bills,omitempty"`
	...
	ModuleAccountYodlee                  *Bool      `xmlrpc:"module_account_yodlee,omitempty" json:"module_account_yodlee,omitempty"`
	...
	ModuleBaseGengo                      *Bool      `xmlrpc:"module_base_gengo,omitempty" json:"module_base_gengo,omitempty"`
	...
	ModuleCrmIapLead                     *Bool      `xmlrpc:"module_crm_iap_lead,omitempty" json:"module_crm_iap_lead,omitempty"`
	ModuleCrmIapLeadEnrich               *Bool      `xmlrpc:"module_crm_iap_lead_enrich,omitempty" json:"module_crm_iap_lead_enrich,omitempty"`
	ModuleCrmIapLeadWebsite              *Bool      `xmlrpc:"module_crm_iap_lead_website,omitempty" json:"module_crm_iap_lead_website,omitempty"`
	...
	ModuleGoogleDrive                    *Bool      `xmlrpc:"module_google_drive,omitempty" json:"module_google_drive,omitempty"`
	ModuleGoogleSpreadsheet              *Bool      `xmlrpc:"module_google_spreadsheet,omitempty" json:"module_google_spreadsheet,omitempty"`
	ModuleHrAttendance                   *Bool      `xmlrpc:"module_hr_attendance,omitempty" json:"module_hr_attendance,omitempty"`
	ModuleHrOrgChart                     *Bool      `xmlrpc:"module_hr_org_chart,omitempty" json:"module_hr_org_chart,omitempty"`
	...
	ModuleHrRecruitmentSurvey            *Bool      `xmlrpc:"module_hr_recruitment_survey,omitempty" json:"module_hr_recruitment_survey,omitempty"`
	...
	ModuleInterCompanyRules              *Bool      `xmlrpc:"module_inter_company_rules,omitempty" json:"module_inter_company_rules,omitempty"`
	ModuleKnowsystemCustomFields         *Bool      `xmlrpc:"module_knowsystem_custom_fields,omitempty" json:"module_knowsystem_custom_fields,omitempty"`
	ModuleKnowsystemMultilang            *Bool      `xmlrpc:"module_knowsystem_multilang,omitempty" json:"module_knowsystem_multilang,omitempty"`
	ModuleKnowsystemWebsite              *Bool      `xmlrpc:"module_knowsystem_website,omitempty" json:"module_knowsystem_website,omitempty"`
	ModuleKnowsystemWebsiteCustomFields  *Bool      `xmlrpc:"module_knowsystem_website_custom_fields,omitempty" json:"module_knowsystem_website_custom_fields,omitempty"`
	ModuleL10NEuService                  *Bool      `xmlrpc:"module_l10n_eu_service,omitempty" json:"module_l10n_eu_service,omitempty"`
	ModuleOcnClient                      *Bool      `xmlrpc:"module_ocn_client,omitempty" json:"module_ocn_client,omitempty"`
	ModulePad                            *Bool      `xmlrpc:"module_pad,omitempty" json:"module_pad,omitempty"`
	ModulePartnerAutocomplete            *Bool      `xmlrpc:"module_partner_autocomplete,omitempty" json:"module_partner_autocomplete,omitempty"`
	ModuleProcurementJit                 *Selection `xmlrpc:"module_procurement_jit,omitempty" json:"module_procurement_jit,omitempty"`
	...
	ModuleProjectForecast                *Bool      `xmlrpc:"module_project_forecast,omitempty" json:"module_project_forecast,omitempty"`
	...
	ModuleProjectTimesheetSynchro        *Bool      `xmlrpc:"module_project_timesheet_synchro,omitempty" json:"module_project_timesheet_synchro,omitempty"`
	...
	ModuleSaleCoupon                     *Bool      `xmlrpc:"module_sale_coupon,omitempty" json:"module_sale_coupon,omitempty"`
	ModuleSaleMargin                     *Bool      `xmlrpc:"module_sale_margin,omitempty" json:"module_sale_margin,omitempty"`
	ModuleSaleProductConfigurator        *Bool      `xmlrpc:"module_sale_product_configurator,omitempty" json:"module_sale_product_configurator,omitempty"`
	ModuleSaleProductMatrix              *Bool      `xmlrpc:"module_sale_product_matrix,omitempty" json:"module_sale_product_matrix,omitempty"`
	ModuleSaleQuotationBuilder           *Bool      `xmlrpc:"module_sale_quotation_builder,omitempty" json:"module_sale_quotation_builder,omitempty"`
	ModuleSaleRentingSign                *Bool      `xmlrpc:"module_sale_renting_sign,omitempty" json:"module_sale_renting_sign,omitempty"`
	...
	ModuleWebsiteHrRecruitment           *Bool      `xmlrpc:"module_website_hr_recruitment,omitempty" json:"module_website_hr_recruitment,omitempty"`
	ModuleWebsiteLinks                   *Bool      `xmlrpc:"module_website_links,omitempty" json:"module_website_links,omitempty"`
	ModuleWebsiteSaleDigital             *Bool      `xmlrpc:"module_website_sale_digital,omitempty" json:"module_website_sale_digital,omitempty"`
	ModuleWebsiteVersion                 *Bool      `xmlrpc:"module_website_version,omitempty" json:"module_website_version,omitempty"`
	PaddingTime                          *Float     `xmlrpc:"padding_time,omitempty" json:"padding_time,omitempty"`
	...
	PlanningAllowSelfUnassign            *Bool      `xmlrpc:"planning_allow_self_unassign,omitempty" json:"planning_allow_self_unassign,omitempty"`
	PlanningGenerationInterval           *Int       `xmlrpc:"planning_generation_interval,omitempty" json:"planning_generation_interval,omitempty"`
	...
	ProjectFolder                        *Many2One  `xmlrpc:"project_folder,omitempty" json:"project_folder,omitempty"`
	ProjectTags                          *Relation  `xmlrpc:"project_tags,omitempty" json:"project_tags,omitempty"`
	...
	RecruitmentFolderId                  *Many2One  `xmlrpc:"recruitment_folder_id,omitempty" json:"recruitment_folder_id,omitempty"`
	RecruitmentTagIds                    *Relation  `xmlrpc:"recruitment_tag_ids,omitempty" json:"recruitment_tag_ids,omitempty"`
	ReminderManagerAllow                 *Bool      `xmlrpc:"reminder_manager_allow,omitempty" json:"reminder_manager_allow,omitempty"`
	ReminderManagerDelay                 *Int       `xmlrpc:"reminder_manager_delay,omitempty" json:"reminder_manager_delay,omitempty"`
	ReminderManagerInterval              *Selection `xmlrpc:"reminder_manager_interval,omitempty" json:"reminder_manager_interval,omitempty"`
	...
	ReportTablePosition                  *Bool      `xmlrpc:"report_table_position,omitempty" json:"report_table_position,omitempty"`
	ReportTablePositionContinuous        *Bool      `xmlrpc:"report_table_position_continuous,omitempty" json:"report_table_position_continuous,omitempty"`
	...
	ShowBlacklistButtons                 *Bool      `xmlrpc:"show_blacklist_buttons,omitempty" json:"show_blacklist_buttons,omitempty"`
	ShowEffect                           *Bool      `xmlrpc:"show_effect,omitempty" json:"show_effect,omitempty"`
	ShowLineSubtotalsTaxSelection        *Selection `xmlrpc:"show_line_subtotals_tax_selection,omitempty" json:"show_line_subtotals_tax_selection,omitempty"`
	...
	StockMailConfirmationTemplateId      *Many2One  `xmlrpc:"stock_mail_confirmation_template_id,omitempty" json:"stock_mail_confirmation_template_id,omitempty"`
	...
	UseMailgateway                       *Bool      `xmlrpc:"use_mailgateway,omitempty" json:"use_mailgateway,omitempty"`
	UsePoLead                            *Bool      `xmlrpc:"use_po_lead,omitempty" json:"use_po_lead,omitempty"`
	UseQuotationValidityDays             *Bool      `xmlrpc:"use_quotation_validity_days,omitempty" json:"use_quotation_validity_days,omitempty"`
	...
	WebsiteCompanyId                     *Many2One  `xmlrpc:"website_company_id,omitempty" json:"website_company_id,omitempty"`
	WebsiteCountryGroupIds               *Relation  `xmlrpc:"website_country_group_ids,omitempty" json:"website_country_group_ids,omitempty"`
	WebsiteDefaultLangCode               *String    `xmlrpc:"website_default_lang_code,omitempty" json:"website_default_lang_code,omitempty"`
	WebsiteDefaultLangId                 *Many2One  `xmlrpc:"website_default_lang_id,omitempty" json:"website_default_lang_id,omitempty"`
	WebsiteDomain                        *String    `xmlrpc:"website_domain,omitempty" json:"website_domain,omitempty"`
	...
	WebsiteLanguageCount                 *Int       `xmlrpc:"website_language_count,omitempty" json:"website_language_count,omitempty"`
	WebsiteLogo                          *String    `xmlrpc:"website_logo,omitempty" json:"website_logo,omitempty"`
	WebsiteName                          *String    `xmlrpc:"website_name,omitempty" json:"website_name,omitempty"`

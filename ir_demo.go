...
func (c *Client) CreateIrDemos(IDs []*IrDemo) ([]int64, error) {
	...
	return c.Create(IrDemoModel, vv)
}
...
func (c *Client) FindIrDemo(criteria *Criteria) (*IrDemo, error) {
	...
	return nil, fmt.Errorf("ir.demo was not found with criteria %v", criteria)
}
...
func (c *Client) FindIrDemoId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("ir.demo was not found with criteria %v and options %v", criteria, options)
}

...
type HrLeaveAllocation struct {
	...
	AccrualLimit                *Int       `xmlrpc:"accrual_limit,omitempty" json:"accrual_limit,omitempty"`
	...
	IntervalUnit                *Selection `xmlrpc:"interval_unit,omitempty" json:"interval_unit,omitempty"`
	...
	NumberPerInterval           *Float     `xmlrpc:"number_per_interval,omitempty" json:"number_per_interval,omitempty"`
	...
	UnitPerInterval             *Selection `xmlrpc:"unit_per_interval,omitempty" json:"unit_per_interval,omitempty"`

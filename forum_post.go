...
type ForumPost struct {
	...
	BumpDate                 *Time      `xmlrpc:"bump_date,omitempty" json:"bump_date,omitempty"`
	CanAccept                *Bool      `xmlrpc:"can_accept,omitempty" json:"can_accept,omitempty"`
	CanAnswer                *Bool      `xmlrpc:"can_answer,omitempty" json:"can_answer,omitempty"`
	CanAsk                   *Bool      `xmlrpc:"can_ask,omitempty" json:"can_ask,omitempty"`
	CanClose                 *Bool      `xmlrpc:"can_close,omitempty" json:"can_close,omitempty"`
	CanComment               *Bool      `xmlrpc:"can_comment,omitempty" json:"can_comment,omitempty"`
	CanCommentConvert        *Bool      `xmlrpc:"can_comment_convert,omitempty" json:"can_comment_convert,omitempty"`
	CanDisplayBiography      *Bool      `xmlrpc:"can_display_biography,omitempty" json:"can_display_biography,omitempty"`
	CanDownvote              *Bool      `xmlrpc:"can_downvote,omitempty" json:"can_downvote,omitempty"`
	CanEdit                  *Bool      `xmlrpc:"can_edit,omitempty" json:"can_edit,omitempty"`
	CanFlag                  *Bool      `xmlrpc:"can_flag,omitempty" json:"can_flag,omitempty"`
	CanModerate              *Bool      `xmlrpc:"can_moderate,omitempty" json:"can_moderate,omitempty"`
	CanPost                  *Bool      `xmlrpc:"can_post,omitempty" json:"can_post,omitempty"`
	CanUnlink                *Bool      `xmlrpc:"can_unlink,omitempty" json:"can_unlink,omitempty"`
	CanUpvote                *Bool      `xmlrpc:"can_upvote,omitempty" json:"can_upvote,omitempty"`
	CanView                  *Bool      `xmlrpc:"can_view,omitempty" json:"can_view,omitempty"`
	...
	ClosedDate               *Time      `xmlrpc:"closed_date,omitempty" json:"closed_date,omitempty"`
	ClosedReasonId           *Many2One  `xmlrpc:"closed_reason_id,omitempty" json:"closed_reason_id,omitempty"`
	ClosedUid                *Many2One  `xmlrpc:"closed_uid,omitempty" json:"closed_uid,omitempty"`
	Content                  *String    `xmlrpc:"content,omitempty" json:"content,omitempty"`
	CreateDate               *Time      `xmlrpc:"create_date,omitempty" json:"create_date,omitempty"`
	CreateUid                *Many2One  `xmlrpc:"create_uid,omitempty" json:"create_uid,omitempty"`
	DisplayName              *String    `xmlrpc:"display_name,omitempty" json:"display_name,omitempty"`
	FavouriteCount           *Int       `xmlrpc:"favourite_count,omitempty" json:"favourite_count,omitempty"`
	FavouriteIds             *Relation  `xmlrpc:"favourite_ids,omitempty" json:"favourite_ids,omitempty"`
	FlagUserId               *Many2One  `xmlrpc:"flag_user_id,omitempty" json:"flag_user_id,omitempty"`
	ForumId                  *Many2One  `xmlrpc:"forum_id,omitempty" json:"forum_id,omitempty"`
	HasValidatedAnswer       *Bool      `xmlrpc:"has_validated_answer,omitempty" json:"has_validated_answer,omitempty"`
	Id                       *Int       `xmlrpc:"id,omitempty" json:"id,omitempty"`
	IsCorrect                *Bool      `xmlrpc:"is_correct,omitempty" json:"is_correct,omitempty"`
	IsSeoOptimized           *Bool      `xmlrpc:"is_seo_optimized,omitempty" json:"is_seo_optimized,omitempty"`
	KarmaAccept              *Int       `xmlrpc:"karma_accept,omitempty" json:"karma_accept,omitempty"`
	KarmaClose               *Int       `xmlrpc:"karma_close,omitempty" json:"karma_close,omitempty"`
	KarmaComment             *Int       `xmlrpc:"karma_comment,omitempty" json:"karma_comment,omitempty"`
	KarmaCommentConvert      *Int       `xmlrpc:"karma_comment_convert,omitempty" json:"karma_comment_convert,omitempty"`
	KarmaEdit                *Int       `xmlrpc:"karma_edit,omitempty" json:"karma_edit,omitempty"`
	KarmaFlag                *Int       `xmlrpc:"karma_flag,omitempty" json:"karma_flag,omitempty"`
	KarmaUnlink              *Int       `xmlrpc:"karma_unlink,omitempty" json:"karma_unlink,omitempty"`
	...
	PlainContent             *String    `xmlrpc:"plain_content,omitempty" json:"plain_content,omitempty"`
	Relevancy                *Float     `xmlrpc:"relevancy,omitempty" json:"relevancy,omitempty"`
	SelfReply                *Bool      `xmlrpc:"self_reply,omitempty" json:"self_reply,omitempty"`
	State                    *Selection `xmlrpc:"state,omitempty" json:"state,omitempty"`
	TagIds                   *Relation  `xmlrpc:"tag_ids,omitempty" json:"tag_ids,omitempty"`
	UidHasAnswered           *Bool      `xmlrpc:"uid_has_answered,omitempty" json:"uid_has_answered,omitempty"`
	UserFavourite            *Bool      `xmlrpc:"user_favourite,omitempty" json:"user_favourite,omitempty"`
	UserVote                 *Int       `xmlrpc:"user_vote,omitempty" json:"user_vote,omitempty"`
	Views                    *Int       `xmlrpc:"views,omitempty" json:"views,omitempty"`
	VoteCount                *Int       `xmlrpc:"vote_count,omitempty" json:"vote_count,omitempty"`
	VoteIds                  *Relation  `xmlrpc:"vote_ids,omitempty" json:"vote_ids,omitempty"`

...
type AccountMergeWizardLine struct {
	AccountHasHashedEntries *Bool      `xmlrpc:"account_has_hashed_entries,omitempty" json:"account_has_hashed_entries,omitempty"`
	...
	GroupingKey             *String    `xmlrpc:"grouping_key,omitempty" json:"grouping_key,omitempty"`
	Id                      *Int       `xmlrpc:"id,omitempty" json:"id,omitempty"`
	Info                    *String    `xmlrpc:"info,omitempty" json:"info,omitempty"`
	IsSelected              *Bool      `xmlrpc:"is_selected,omitempty" json:"is_selected,omitempty"`

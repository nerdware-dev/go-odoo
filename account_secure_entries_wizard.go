...
type AccountSecureEntriesWizard struct {
	ChainsToHashWithGaps             interface{} `xmlrpc:"chains_to_hash_with_gaps,omitempty" json:"chains_to_hash_with_gaps,omitempty"`
	...
	HashDate                         *Time       `xmlrpc:"hash_date,omitempty" json:"hash_date,omitempty"`
	Id                               *Int        `xmlrpc:"id,omitempty" json:"id,omitempty"`
	MaxHashDate                      *Time       `xmlrpc:"max_hash_date,omitempty" json:"max_hash_date,omitempty"`
	MoveToHashIds                    *Relation   `xmlrpc:"move_to_hash_ids,omitempty" json:"move_to_hash_ids,omitempty"`
	NotHashableUnlockedMoveIds       *Relation   `xmlrpc:"not_hashable_unlocked_move_ids,omitempty" json:"not_hashable_unlocked_move_ids,omitempty"`
	UnreconciledBankStatementLineIds *Relation   `xmlrpc:"unreconciled_bank_statement_line_ids,omitempty" json:"unreconciled_bank_statement_line_ids,omitempty"`
	Warnings                         interface{} `xmlrpc:"warnings,omitempty" json:"warnings,omitempty"`

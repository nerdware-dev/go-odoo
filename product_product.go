...
type ProductProduct struct {
	...
	AdditionalProductTagIds                *Relation   `xmlrpc:"additional_product_tag_ids,omitempty" json:"additional_product_tag_ids,omitempty"`
	AllProductTagIds                       *Relation   `xmlrpc:"all_product_tag_ids,omitempty" json:"all_product_tag_ids,omitempty"`
	AttributeLineIds                       *Relation   `xmlrpc:"attribute_line_ids,omitempty" json:"attribute_line_ids,omitempty"`
	AvgCost                                *Float      `xmlrpc:"avg_cost,omitempty" json:"avg_cost,omitempty"`
	...
	CanImageVariant1024BeZoomed            *Bool       `xmlrpc:"can_image_variant_1024_be_zoomed,omitempty" json:"can_image_variant_1024_be_zoomed,omitempty"`
	...
	CombinationIndices                     *String     `xmlrpc:"combination_indices,omitempty" json:"combination_indices,omitempty"`
	...
	ExpectedMargin                         *Float      `xmlrpc:"expected_margin,omitempty" json:"expected_margin,omitempty"`
	ExpectedMarginRate                     *Float      `xmlrpc:"expected_margin_rate,omitempty" json:"expected_margin_rate,omitempty"`
	...
	FreeQty                                *Float      `xmlrpc:"free_qty,omitempty" json:"free_qty,omitempty"`
	...
	ImageVariant1024                       *String     `xmlrpc:"image_variant_1024,omitempty" json:"image_variant_1024,omitempty"`
	ImageVariant128                        *String     `xmlrpc:"image_variant_128,omitempty" json:"image_variant_128,omitempty"`
	ImageVariant1920                       *String     `xmlrpc:"image_variant_1920,omitempty" json:"image_variant_1920,omitempty"`
	ImageVariant256                        *String     `xmlrpc:"image_variant_256,omitempty" json:"image_variant_256,omitempty"`
	ImageVariant512                        *String     `xmlrpc:"image_variant_512,omitempty" json:"image_variant_512,omitempty"`
	...
	LotPropertiesDefinition                interface{} `xmlrpc:"lot_properties_definition,omitempty" json:"lot_properties_definition,omitempty"`
	LstPrice                               *Float      `xmlrpc:"lst_price,omitempty" json:"lst_price,omitempty"`
	...
	NormalCost                             *Float      `xmlrpc:"normal_cost,omitempty" json:"normal_cost,omitempty"`
	...
	ProductCatalogProductIsInSaleOrder     *Bool       `xmlrpc:"product_catalog_product_is_in_sale_order,omitempty" json:"product_catalog_product_is_in_sale_order,omitempty"`
	...
	PurchaseAvgPrice                       *Float      `xmlrpc:"purchase_avg_price,omitempty" json:"purchase_avg_price,omitempty"`
	PurchaseGap                            *Float      `xmlrpc:"purchase_gap,omitempty" json:"purchase_gap,omitempty"`
	...
	PurchaseNumInvoiced                    *Float      `xmlrpc:"purchase_num_invoiced,omitempty" json:"purchase_num_invoiced,omitempty"`
	PurchaseOk                             *Bool       `xmlrpc:"purchase_ok,omitempty" json:"purchase_ok,omitempty"`
	PurchaseOrderLineIds                   *Relation   `xmlrpc:"purchase_order_line_ids,omitempty" json:"purchase_order_line_ids,omitempty"`
	...
	SaleAvgPrice                           *Float      `xmlrpc:"sale_avg_price,omitempty" json:"sale_avg_price,omitempty"`
	SaleDelay                              *Int        `xmlrpc:"sale_delay,omitempty" json:"sale_delay,omitempty"`
	SaleExpected                           *Float      `xmlrpc:"sale_expected,omitempty" json:"sale_expected,omitempty"`
	...
	SaleNumInvoiced                        *Float      `xmlrpc:"sale_num_invoiced,omitempty" json:"sale_num_invoiced,omitempty"`
	...
	SalesGap                               *Float      `xmlrpc:"sales_gap,omitempty" json:"sales_gap,omitempty"`
	...
	StandardPriceUpdateWarning             *String     `xmlrpc:"standard_price_update_warning,omitempty" json:"standard_price_update_warning,omitempty"`
	StockMoveIds                           *Relation   `xmlrpc:"stock_move_ids,omitempty" json:"stock_move_ids,omitempty"`
	StockQuantIds                          *Relation   `xmlrpc:"stock_quant_ids,omitempty" json:"stock_quant_ids,omitempty"`
	StockValuationLayerIds                 *Relation   `xmlrpc:"stock_valuation_layer_ids,omitempty" json:"stock_valuation_layer_ids,omitempty"`
	StorageCategoryCapacityIds             *Relation   `xmlrpc:"storage_category_capacity_ids,omitempty" json:"storage_category_capacity_ids,omitempty"`
	...
	TotalCost                              *Float      `xmlrpc:"total_cost,omitempty" json:"total_cost,omitempty"`
	TotalMargin                            *Float      `xmlrpc:"total_margin,omitempty" json:"total_margin,omitempty"`
	TotalMarginRate                        *Float      `xmlrpc:"total_margin_rate,omitempty" json:"total_margin_rate,omitempty"`
	TotalValue                             *Float      `xmlrpc:"total_value,omitempty" json:"total_value,omitempty"`
	Tracking                               *Selection  `xmlrpc:"tracking,omitempty" json:"tracking,omitempty"`
	Turnover                               *Float      `xmlrpc:"turnover,omitempty" json:"turnover,omitempty"`
	...
	ValidEan                               *Bool       `xmlrpc:"valid_ean,omitempty" json:"valid_ean,omitempty"`
	...
	ValueSvl                               *Float      `xmlrpc:"value_svl,omitempty" json:"value_svl,omitempty"`

...
type ProductProduct struct {
	...
	ComboIds                             *Relation   `xmlrpc:"combo_ids,omitempty" json:"combo_ids,omitempty"`
	...
	IsInPurchaseOrder                    *Bool       `xmlrpc:"is_in_purchase_order,omitempty" json:"is_in_purchase_order,omitempty"`
	...
	UomCategoryId                        *Many2One   `xmlrpc:"uom_category_id,omitempty" json:"uom_category_id,omitempty"`

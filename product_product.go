...
type ProductProduct struct {
	...
	NormalCost                             *Float      `xmlrpc:"normal_cost,omitempty"`
	...
	PurchaseAvgPrice                       *Float      `xmlrpc:"purchase_avg_price,omitempty"`
	PurchaseGap                            *Float      `xmlrpc:"purchase_gap,omitempty"`
	...
	PurchaseNumInvoiced                    *Float      `xmlrpc:"purchase_num_invoiced,omitempty"`
	...
	SaleAvgPrice                           *Float      `xmlrpc:"sale_avg_price,omitempty"`
	SaleDelay                              *Int        `xmlrpc:"sale_delay,omitempty"`
	SaleExpected                           *Float      `xmlrpc:"sale_expected,omitempty"`
	SaleLineWarn                           *Selection  `xmlrpc:"sale_line_warn,omitempty"`
	SaleLineWarnMsg                        *String     `xmlrpc:"sale_line_warn_msg,omitempty"`
	SaleNumInvoiced                        *Float      `xmlrpc:"sale_num_invoiced,omitempty"`
	...
	TotalMargin                            *Float      `xmlrpc:"total_margin,omitempty"`
	TotalMarginRate                        *Float      `xmlrpc:"total_margin_rate,omitempty"`
	TotalValue                             *Float      `xmlrpc:"total_value,omitempty"`
	Tracking                               *Selection  `xmlrpc:"tracking,omitempty"`
	Turnover                               *Float      `xmlrpc:"turnover,omitempty"`

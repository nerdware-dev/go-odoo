...
type HrSkillType struct {
	...
	SkillLevelIds *Relation `xmlrpc:"skill_level_ids,omptempty"`
...
func (c *Client) CreateHrSkillTypes(hsts []*HrSkillType) ([]int64, error) {
	...
	return c.Create(HrSkillTypeModel, vv)
}
...
func (c *Client) UpdateHrSkillTypes(ids []int64, hst *HrSkillType) error {
	return c.Update(HrSkillTypeModel, ids, hst)
}
...
func (c *Client) GetHrSkillType(id int64) (*HrSkillType, error) {
	...
	if hsts != nil && len(*hsts) > 0 {
		return &((*hsts)[0]), nil
	}
	return nil, fmt.Errorf("id %v of hr.skill.type not found", id)
}
...
func (c *Client) FindHrSkillType(criteria *Criteria) (*HrSkillType, error) {
	...
	return nil, fmt.Errorf("hr.skill.type was not found with criteria %v", criteria)
}
...
func (c *Client) FindHrSkillTypeId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("hr.skill.type was not found with criteria %v and options %v", criteria, options)
}

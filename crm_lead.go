...
type CrmLead struct {
	...
	AutomatedProbability            *Float      `xmlrpc:"automated_probability,omitempty" json:"automated_probability,omitempty"`
	...
	CompanyCurrency                 *Many2One   `xmlrpc:"company_currency,omitempty" json:"company_currency,omitempty"`
	CompanyId                       *Many2One   `xmlrpc:"company_id,omitempty" json:"company_id,omitempty"`
	ContactName                     *String     `xmlrpc:"contact_name,omitempty" json:"contact_name,omitempty"`
	CountryId                       *Many2One   `xmlrpc:"country_id,omitempty" json:"country_id,omitempty"`
	CreateDate                      *Time       `xmlrpc:"create_date,omitempty" json:"create_date,omitempty"`
	CreateUid                       *Many2One   `xmlrpc:"create_uid,omitempty" json:"create_uid,omitempty"`
	DateAutomationLast              *Time       `xmlrpc:"date_automation_last,omitempty" json:"date_automation_last,omitempty"`
	...
	DateOpen                        *Time       `xmlrpc:"date_open,omitempty" json:"date_open,omitempty"`
	DayClose                        *Float      `xmlrpc:"day_close,omitempty" json:"day_close,omitempty"`
	DayOpen                         *Float      `xmlrpc:"day_open,omitempty" json:"day_open,omitempty"`
	DaysExceedingClosing            *Float      `xmlrpc:"days_exceeding_closing,omitempty" json:"days_exceeding_closing,omitempty"`
	DaysToConvert                   *Float      `xmlrpc:"days_to_convert,omitempty" json:"days_to_convert,omitempty"`
	Description                     *String     `xmlrpc:"description,omitempty" json:"description,omitempty"`
	DisplayName                     *String     `xmlrpc:"display_name,omitempty" json:"display_name,omitempty"`
	DuplicateLeadCount              *Int        `xmlrpc:"duplicate_lead_count,omitempty" json:"duplicate_lead_count,omitempty"`
	DuplicateLeadIds                *Relation   `xmlrpc:"duplicate_lead_ids,omitempty" json:"duplicate_lead_ids,omitempty"`
	...
	EmailDomainCriterion            *String     `xmlrpc:"email_domain_criterion,omitempty" json:"email_domain_criterion,omitempty"`
	...
	IsPartnerVisible                *Bool       `xmlrpc:"is_partner_visible,omitempty" json:"is_partner_visible,omitempty"`
	KanbanState                     *Selection  `xmlrpc:"kanban_state,omitempty" json:"kanban_state,omitempty"`
	LangActiveCount                 *Int        `xmlrpc:"lang_active_count,omitempty" json:"lang_active_count,omitempty"`
	LangCode                        *String     `xmlrpc:"lang_code,omitempty" json:"lang_code,omitempty"`
	LangId                          *Many2One   `xmlrpc:"lang_id,omitempty" json:"lang_id,omitempty"`
	LeadProperties                  interface{} `xmlrpc:"lead_properties,omitempty" json:"lead_properties,omitempty"`
	LostReasonId                    *Many2One   `xmlrpc:"lost_reason_id,omitempty" json:"lost_reason_id,omitempty"`
	MediumId                        *Many2One   `xmlrpc:"medium_id,omitempty" json:"medium_id,omitempty"`
	MeetingDisplayDate              *Time       `xmlrpc:"meeting_display_date,omitempty" json:"meeting_display_date,omitempty"`
	MeetingDisplayLabel             *String     `xmlrpc:"meeting_display_label,omitempty" json:"meeting_display_label,omitempty"`
	...
	OrderIds                        *Relation   `xmlrpc:"order_ids,omitempty" json:"order_ids,omitempty"`
	PartnerEmailUpdate              *Bool       `xmlrpc:"partner_email_update,omitempty" json:"partner_email_update,omitempty"`
	PartnerId                       *Many2One   `xmlrpc:"partner_id,omitempty" json:"partner_id,omitempty"`
	PartnerIsBlacklisted            *Bool       `xmlrpc:"partner_is_blacklisted,omitempty" json:"partner_is_blacklisted,omitempty"`
	PartnerName                     *String     `xmlrpc:"partner_name,omitempty" json:"partner_name,omitempty"`
	PartnerPhoneUpdate              *Bool       `xmlrpc:"partner_phone_update,omitempty" json:"partner_phone_update,omitempty"`
	...
	PhoneState                      *Selection  `xmlrpc:"phone_state,omitempty" json:"phone_state,omitempty"`
	Priority                        *Selection  `xmlrpc:"priority,omitempty" json:"priority,omitempty"`
	Probability                     *Float      `xmlrpc:"probability,omitempty" json:"probability,omitempty"`
	ProratedRevenue                 *Float      `xmlrpc:"prorated_revenue,omitempty" json:"prorated_revenue,omitempty"`
	...
	RecurringPlan                   *Many2One   `xmlrpc:"recurring_plan,omitempty" json:"recurring_plan,omitempty"`
	RecurringRevenue                *Float      `xmlrpc:"recurring_revenue,omitempty" json:"recurring_revenue,omitempty"`
	RecurringRevenueMonthly         *Float      `xmlrpc:"recurring_revenue_monthly,omitempty" json:"recurring_revenue_monthly,omitempty"`
	RecurringRevenueMonthlyProrated *Float      `xmlrpc:"recurring_revenue_monthly_prorated,omitempty" json:"recurring_revenue_monthly_prorated,omitempty"`
	RecurringRevenueProrated        *Float      `xmlrpc:"recurring_revenue_prorated,omitempty" json:"recurring_revenue_prorated,omitempty"`
	Referred                        *String     `xmlrpc:"referred,omitempty" json:"referred,omitempty"`
	...
	UserCompanyIds                  *Relation   `xmlrpc:"user_company_ids,omitempty" json:"user_company_ids,omitempty"`

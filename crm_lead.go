...
type CrmLead struct {
	...
	LostReason                  *Many2One  `xmlrpc:"lost_reason,omitempty" json:"lost_reason,omitempty"`
	...
	PartnerAddressEmail         *String    `xmlrpc:"partner_address_email,omitempty" json:"partner_address_email,omitempty"`
	PartnerAddressName          *String    `xmlrpc:"partner_address_name,omitempty" json:"partner_address_name,omitempty"`
	PartnerAddressPhone         *String    `xmlrpc:"partner_address_phone,omitempty" json:"partner_address_phone,omitempty"`
	...
	PlannedRevenue              *Float     `xmlrpc:"planned_revenue,omitempty" json:"planned_revenue,omitempty"`

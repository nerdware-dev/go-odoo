...
type IrModel struct {
	...
	WebsiteFormAccess         *Bool      `xmlrpc:"website_form_access,omitempty" json:"website_form_access,omitempty"`
	WebsiteFormDefaultFieldId *Many2One  `xmlrpc:"website_form_default_field_id,omitempty" json:"website_form_default_field_id,omitempty"`
	WebsiteFormKey            *String    `xmlrpc:"website_form_key,omitempty" json:"website_form_key,omitempty"`
	WebsiteFormLabel          *String    `xmlrpc:"website_form_label,omitempty" json:"website_form_label,omitempty"`

...
type AccountJournal struct {
	...
	AccountOnlineAccountId          *Many2One  `xmlrpc:"account_online_account_id,omitempty"`
	AccountOnlineLinkId             *Many2One  `xmlrpc:"account_online_link_id,omitempty"`
	AccountOnlineLinkState          *Selection `xmlrpc:"account_online_link_state,omitempty"`
	...
	AliasAutoExtractPdfsOnly        *Bool      `xmlrpc:"alias_auto_extract_pdfs_only,omitempty"`
	...
	DisplayAliasAutoExtractPdfsOnly *Bool      `xmlrpc:"display_alias_auto_extract_pdfs_only,omitempty"`
	...
	ExpiringSynchronizationDueDay   *Int       `xmlrpc:"expiring_synchronization_due_day,omitempty"`
	...
	NextLinkSynchronization         *Time      `xmlrpc:"next_link_synchronization,omitempty"`
	OnlineSyncFetchingStatus        *Selection `xmlrpc:"online_sync_fetching_status,omitempty"`
	...
	RenewalContactEmail             *String    `xmlrpc:"renewal_contact_email,omitempty"`

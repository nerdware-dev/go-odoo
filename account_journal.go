...
type AccountJournal struct {
	...
	AccountOnlineAccountId          *Many2One  `xmlrpc:"account_online_account_id,omitempty" json:"account_online_account_id,omitempty"`
	AccountOnlineLinkId             *Many2One  `xmlrpc:"account_online_link_id,omitempty" json:"account_online_link_id,omitempty"`
	AccountOnlineLinkState          *Selection `xmlrpc:"account_online_link_state,omitempty" json:"account_online_link_state,omitempty"`
	...
	AliasAutoExtractPdfsOnly        *Bool      `xmlrpc:"alias_auto_extract_pdfs_only,omitempty" json:"alias_auto_extract_pdfs_only,omitempty"`
	...
	EntriesCount                    *Int       `xmlrpc:"entries_count,omitempty" json:"entries_count,omitempty"`
	...
	InboundPaymentMethodLineIds     *Relation  `xmlrpc:"inbound_payment_method_line_ids,omitempty" json:"inbound_payment_method_line_ids,omitempty"`
	...
	LastStatementId                 *Many2One  `xmlrpc:"last_statement_id,omitempty" json:"last_statement_id,omitempty"`
	...
	NextLinkSynchronization         *Time      `xmlrpc:"next_link_synchronization,omitempty" json:"next_link_synchronization,omitempty"`
	OnlineSyncFetchingStatus        *Selection `xmlrpc:"online_sync_fetching_status,omitempty" json:"online_sync_fetching_status,omitempty"`
	OutboundPaymentMethodLineIds    *Relation  `xmlrpc:"outbound_payment_method_line_ids,omitempty" json:"outbound_payment_method_line_ids,omitempty"`
	PaymentSequence                 *Bool      `xmlrpc:"payment_sequence,omitempty" json:"payment_sequence,omitempty"`
	...
	RenewalContactEmail             *String    `xmlrpc:"renewal_contact_email,omitempty" json:"renewal_contact_email,omitempty"`
	RestrictModeHashTable           *Bool      `xmlrpc:"restrict_mode_hash_table,omitempty" json:"restrict_mode_hash_table,omitempty"`
	SaleActivityNote                *String    `xmlrpc:"sale_activity_note,omitempty" json:"sale_activity_note,omitempty"`
	SaleActivityTypeId              *Many2One  `xmlrpc:"sale_activity_type_id,omitempty" json:"sale_activity_type_id,omitempty"`
	...
	SuspenseAccountId               *Many2One  `xmlrpc:"suspense_account_id,omitempty" json:"suspense_account_id,omitempty"`

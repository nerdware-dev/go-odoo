...
func (c *Client) CreateSnailmailLetters(sls []*SnailmailLetter) ([]int64, error) {
	...
	return c.Create(SnailmailLetterModel, vv)
}
...
func (c *Client) FindSnailmailLetter(criteria *Criteria) (*SnailmailLetter, error) {
	...
	return nil, fmt.Errorf("snailmail.letter was not found with criteria %v", criteria)
}
...
func (c *Client) FindSnailmailLetterId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("snailmail.letter was not found with criteria %v and options %v", criteria, options)
}

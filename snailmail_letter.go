...
type SnailmailLetter struct {
	...
	AttachmentDatas *String    `xmlrpc:"attachment_datas,omitempty" json:"attachment_datas,omitempty"`
	AttachmentFname *String    `xmlrpc:"attachment_fname,omitempty" json:"attachment_fname,omitempty"`
	...
	Color           *Bool      `xmlrpc:"color,omitempty" json:"color,omitempty"`
	CompanyId       *Many2One  `xmlrpc:"company_id,omitempty" json:"company_id,omitempty"`
	CountryId       *Many2One  `xmlrpc:"country_id,omitempty" json:"country_id,omitempty"`
	Cover           *Bool      `xmlrpc:"cover,omitempty" json:"cover,omitempty"`
	CreateDate      *Time      `xmlrpc:"create_date,omitempty" json:"create_date,omitempty"`
	CreateUid       *Many2One  `xmlrpc:"create_uid,omitempty" json:"create_uid,omitempty"`
	DisplayName     *String    `xmlrpc:"display_name,omitempty" json:"display_name,omitempty"`
	Duplex          *Bool      `xmlrpc:"duplex,omitempty" json:"duplex,omitempty"`
	ErrorCode       *Selection `xmlrpc:"error_code,omitempty" json:"error_code,omitempty"`
	Id              *Int       `xmlrpc:"id,omitempty" json:"id,omitempty"`
	InfoMsg         *String    `xmlrpc:"info_msg,omitempty" json:"info_msg,omitempty"`
...
func (c *Client) CreateSnailmailLetter(sl *SnailmailLetter) (int64, error) {
	ids, err := c.CreateSnailmailLetters([]*SnailmailLetter{sl})
	if err != nil {
		return -1, err
	}
	if len(ids) == 0 {
...
// CreateSnailmailLetter creates a new snailmail.letter model and returns its id.
func (c *Client) CreateSnailmailLetters(sls []*SnailmailLetter) ([]int64, error) {
	var vv []interface{}
	for _, v := range sls {
		vv = append(vv, v)
	}
	return c.Create(SnailmailLetterModel, vv, nil)
}
...
func (c *Client) UpdateSnailmailLetters(ids []int64, sl *SnailmailLetter) error {
	return c.Update(SnailmailLetterModel, ids, sl, nil)
}
...
func (c *Client) FindSnailmailLetterIds(criteria *Criteria, options *Options) ([]int64, error) {
	return c.Search(SnailmailLetterModel, criteria, options)
}

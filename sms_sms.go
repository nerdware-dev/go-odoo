...
func (c *Client) CreateSmsSmss(sss []*SmsSms) ([]int64, error) {
	...
	return c.Create(SmsSmsModel, vv)
}
...
func (c *Client) FindSmsSms(criteria *Criteria) (*SmsSms, error) {
	...
	return nil, fmt.Errorf("sms.sms was not found with criteria %v", criteria)
}
...
func (c *Client) FindSmsSmsId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("sms.sms was not found with criteria %v and options %v", criteria, options)
}
